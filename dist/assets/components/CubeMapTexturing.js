...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-7.0.0")] .require ("standard/Utility/BitSet");
...
const DependentRenderer_namespaceObject = window [Symbol .for ("X_ITE.X3D-7.0.0")] .require ("x_ite/Rendering/DependentRenderer");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-7.0.0")] .require ("x_ite/Rendering/TextureBuffer");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-7.0.0")] .require ("standard/Math/Geometry/ViewVolume");
