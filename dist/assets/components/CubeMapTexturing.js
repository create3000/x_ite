...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.2")] .require ("standard/Utility/BitSet");
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.2")] .require ("x_ite/Rendering/X3DRenderObject");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.2")] .require ("x_ite/Rendering/TextureBuffer");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.2")] .require ("standard/Math/Geometry/ViewVolume");
