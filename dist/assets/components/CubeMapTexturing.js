...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("standard/Utility/BitSet");
...
const X3DBaseNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("x_ite/Base/X3DBaseNode");
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("x_ite/Rendering/X3DRenderObject");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("x_ite/Rendering/TextureBuffer");
...
const Camera_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("standard/Math/Geometry/Camera");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.18")] .require ("standard/Math/Geometry/ViewVolume");
