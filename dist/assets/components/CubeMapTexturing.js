...
const X3DSingleTextureNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
/* harmony default export */ const CubeMapTexturing_X3DEnvironmentTextureNode = (X3DEnvironmentTextureNode);
...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("standard/Utility/BitSet");
...
/* harmony default export */ const CubeMapTexturing_ComposedCubeMapTexture = (ComposedCubeMapTexture);

;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"x_ite/Rendering/DependentRenderer\")"
const DependentRenderer_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("x_ite/Rendering/DependentRenderer");
var DependentRenderer_default = /*#__PURE__*/__webpack_require__.n(DependentRenderer_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"x_ite/Rendering/TextureBuffer\")"
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("x_ite/Rendering/TextureBuffer");
...
const Camera_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("standard/Math/Geometry/Camera");
...
function GeneratedCubeMapTexture (executionContext)
{
   ...
   this .dependentRenderer = new (DependentRenderer_default()) (executionContext);
...
/* harmony default export */ const CubeMapTexturing_GeneratedCubeMapTexture = (GeneratedCubeMapTexture);
...
const DEBUG_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.0.0a")] .require ("x_ite/DEBUG");
