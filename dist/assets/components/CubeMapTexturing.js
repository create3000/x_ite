...
const X3DSingleTextureNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
Namespace_default().addModule ("X3DEnvironmentTextureNode", "x_ite/Components/CubeMapTexturing/X3DEnvironmentTextureNode", __default__);
...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("standard/Utility/BitSet");
...
Namespace_default().addModule ("ComposedCubeMapTexture", "x_ite/Components/CubeMapTexturing/ComposedCubeMapTexture", ComposedCubeMapTexture_default_);
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Rendering/X3DRenderObject");
...
Namespace_default().addModule ("DependentRenderer", "x_ite/Rendering/DependentRenderer", DependentRenderer_default_);
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Rendering/TextureBuffer");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("standard/Math/Geometry/ViewVolume");
...
Namespace_default().addModule ("GeneratedCubeMapTexture", "x_ite/Components/CubeMapTexturing/GeneratedCubeMapTexture", GeneratedCubeMapTexture_default_);
...
const DEVELOPMENT_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/DEVELOPMENT");
...
Namespace_default().addModule ("ImageCubeMapTexture", "x_ite/Components/CubeMapTexturing/ImageCubeMapTexture", ImageCubeMapTexture_default_);
...
Namespace_default().addModule ("CubeMapTexturing", "assets/components/CubeMapTexturing", CubeMapTexturing_default_);
