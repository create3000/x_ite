...
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"x_ite/Components/Texturing/X3DSingleTextureNode\")"
const X3DSingleTextureNode_namespaceObject = X_ITE_X3D .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"x_ite/Rendering/X3DRenderObject\")"
const X3DRenderObject_namespaceObject = X_ITE_X3D .require ("x_ite/Rendering/X3DRenderObject");
...
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"x_ite/Rendering/TextureBuffer\")"
const TextureBuffer_namespaceObject = X_ITE_X3D .require ("x_ite/Rendering/TextureBuffer");
var TextureBuffer_default = /*#__PURE__*/__webpack_require__.n(TextureBuffer_namespaceObject);
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"standard/Math/Geometry/Camera\")"
const Camera_namespaceObject = X_ITE_X3D .require ("standard/Math/Geometry/Camera");
var Camera_default = /*#__PURE__*/__webpack_require__.n(Camera_namespaceObject);
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"standard/Math/Geometry/ViewVolume\")"
const ViewVolume_namespaceObject = X_ITE_X3D .require ("standard/Math/Geometry/ViewVolume");
...
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"standard/Math/Numbers/Vector4\")"
const Vector4_namespaceObject = X_ITE_X3D .require ("standard/Math/Numbers/Vector4");
...
;// CONCATENATED MODULE: external "X_ITE_X3D .require (\"x_ite/DEVELOPMENT\")"
const DEVELOPMENT_namespaceObject = X_ITE_X3D .require ("x_ite/DEVELOPMENT");
