...
const X3DSingleTextureNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/Rendering/X3DRenderObject");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/Rendering/TextureBuffer");
...
const Camera_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("standard/Math/Geometry/Camera");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("standard/Math/Geometry/ViewVolume");
...
const DEVELOPMENT_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/DEVELOPMENT");
