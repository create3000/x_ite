...
const X3DSingleTextureNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("standard/Utility/BitSet");
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("x_ite/Rendering/X3DRenderObject");
var X3DRenderObject_default = /*#__PURE__*/__webpack_require__.n(X3DRenderObject_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"x_ite/Rendering/TraverseType\")"
const TraverseType_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("x_ite/Rendering/TraverseType");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("x_ite/Rendering/TextureBuffer");
...
const Camera_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("standard/Math/Geometry/Camera");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("standard/Math/Geometry/ViewVolume");
...
const Matrix4_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("standard/Math/Numbers/Matrix4");
...
const DEVELOPMENT_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.1")] .require ("x_ite/DEVELOPMENT");
