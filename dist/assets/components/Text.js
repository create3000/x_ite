...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("standard/Math/Geometry/Box2");
var Box2_default = /*#__PURE__*/__webpack_require__.n(Box2_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Geometry/Box3\")"
const Box3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("standard/Math/Geometry/Box3");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.15")] .require ("lib/libtess");
