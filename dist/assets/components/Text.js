...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.1")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.1")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.1")] .require ("standard/Math/Geometry/Box2");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.1")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.1")] .require ("lib/libtess");
