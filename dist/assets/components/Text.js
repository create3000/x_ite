...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("standard/Math/Geometry/Box2");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.2")] .require ("lib/libtess");
...
/* provided dependency */ var opentype = __webpack_require__(400);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
