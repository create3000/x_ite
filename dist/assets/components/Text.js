...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("standard/Math/Geometry/Box2");
...
const Vector2_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("standard/Math/Numbers/Vector2");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("lib/libtess");
...
/* provided dependency */ var opentype = __webpack_require__(660);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("x_ite/Components/Rendering/X3DGeometryNode");
