...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.10.0")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.10.0")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.10.0")] .require ("standard/Math/Geometry/Box2");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.10.0")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.10.0")] .require ("lib/libtess");
...
/* provided dependency */ var opentype = __webpack_require__(506);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
