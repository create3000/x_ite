...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.2")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.2")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.2")] .require ("standard/Math/Geometry/Box3");
...
/* provided dependency */ var opentype = __webpack_require__(807);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
