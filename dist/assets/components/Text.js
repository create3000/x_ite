...
Namespace_default().addModule ("TextAlignment", "x_ite/Browser/Text/TextAlignment", __default__);
...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Browser/Networking/URLs");
...
Namespace_default().addModule ("X3DFontStyleNode", "x_ite/Components/Text/X3DFontStyleNode", X3DFontStyleNode_default_);
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("standard/Math/Geometry/Box2");
...
Namespace_default().addModule ("X3DTextGeometry", "x_ite/Browser/Text/X3DTextGeometry", X3DTextGeometry_default_);
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("lib/libtess");
...
Namespace_default().addModule ("PolygonText", "x_ite/Browser/Text/PolygonText", PolygonText_default_);
...
Namespace_default().addModule ("FontStyle", "x_ite/Components/Text/FontStyle", FontStyle_default_);
...
/* provided dependency */ var opentype = __webpack_require__(215);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
...
Namespace_default().addModule ("X3DTextContext", "x_ite/Browser/Text/X3DTextContext", X3DTextContext_default_);
...
Namespace_default().addModule ("Text", "x_ite/Components/Text/Text", Text_default_);
...
Namespace_default().addModule ("Text", "assets/components/Text", components_Text_default_);
