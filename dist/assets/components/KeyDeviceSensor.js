...
Namespace_default().addModule ("X3DKeyDeviceSensorContext", "x_ite/Browser/KeyDeviceSensor/X3DKeyDeviceSensorContext", __default__);
...
const X3DSensorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Core/X3DSensorNode");
...
Namespace_default().addModule ("X3DKeyDeviceSensorNode", "x_ite/Components/KeyDeviceSensor/X3DKeyDeviceSensorNode", X3DKeyDeviceSensorNode_default_);
...
Namespace_default().addModule ("KeySensor", "x_ite/Components/KeyDeviceSensor/KeySensor", KeySensor_default_);
...
Namespace_default().addModule ("StringSensor", "x_ite/Components/KeyDeviceSensor/StringSensor", StringSensor_default_);
...
Namespace_default().addModule ("KeyDeviceSensor", "assets/components/KeyDeviceSensor", KeyDeviceSensor_default_);
