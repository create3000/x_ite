...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.10")] .require ("standard/Utility/ObjectCache");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.10")] .require ("lib/ammojs/AmmoClass");
