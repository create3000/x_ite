...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11a")] .require ("standard/Utility/ObjectCache");
...
function X3DPickSensorNode (executionContext)
{
   ...
   this .targets .size       = 0;
   this .pickedTargets       = [ ];
   this .pickedTargetsSorter = new (QuickSort_default()) (this .pickedTargets, compareDistance);
...
X3DPickSensorNode .prototype = Object .assign (Object .create ((X3DSensorNode_default()).prototype),
{
   ...
   getPickedGeometry: function (target)
   {
      ...
      if (instance .getType () .indexOf ((X3DConstants_default()).X3DPrototypeInstance) !== -1 && instance .getExecutionContext () === executionContext)
         return instance;
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11a")] .require ("lib/ammojs/AmmoClass");
