...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("standard/Utility/ObjectCache");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("lib/ammojs/AmmoClass");
