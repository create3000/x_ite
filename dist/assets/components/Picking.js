...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3a")] .require ("standard/Utility/ObjectCache");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3a")] .require ("lib/ammojs/AmmoClass");
