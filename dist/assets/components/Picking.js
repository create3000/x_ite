...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.4.4a")] .require ("standard/Utility/ObjectCache");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.4.4a")] .require ("lib/ammojs/AmmoClass");
