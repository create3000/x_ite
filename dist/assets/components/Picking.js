...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.15")] .require ("standard/Utility/ObjectCache");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.15")] .require ("lib/ammojs/AmmoClass");
