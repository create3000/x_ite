...
const GeometryTypes_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Browser/ParticleSystems/GeometryTypes");
...
const GeometryContext_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Browser/Rendering/GeometryContext");
...
const AlphaMode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Browser/Shape/AlphaMode");
...
const LineSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Components/Rendering/LineSet");
...
const Coordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Components/Rendering/Coordinate");
...
const Matrix3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("standard/Math/Numbers/Matrix3");
...
const Plane3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("standard/Math/Geometry/Plane3");
...
const IndexedLineSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Components/Rendering/IndexedLineSet");
...
const IndexedFaceSet_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.2")] .require ("x_ite/Components/Geometry3D/IndexedFaceSet");
