...
const X3DGeometricPropertyNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.5")] .require ("x_ite/Components/Rendering/X3DGeometricPropertyNode");
...
const Group_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.5")] .require ("x_ite/Components/Grouping/Group");
...
const Transform_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.5")] .require ("x_ite/Components/Grouping/Transform");
