...
const X3DGeometricPropertyNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.1")] .require ("x_ite/Components/Rendering/X3DGeometricPropertyNode");
...
const Transform_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.1")] .require ("x_ite/Components/Grouping/Transform");
