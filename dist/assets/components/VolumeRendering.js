...
const PixelTexture_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Texturing/PixelTexture");
...
const TextureProperties_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Texturing/TextureProperties");
...
Namespace_default().addModule ("X3DVolumeRenderStyleNode", "x_ite/Components/VolumeRendering/X3DVolumeRenderStyleNode", __default__);
...
Namespace_default().addModule ("X3DComposableVolumeRenderStyleNode", "x_ite/Components/VolumeRendering/X3DComposableVolumeRenderStyleNode", X3DComposableVolumeRenderStyleNode_default_);
...
Namespace_default().addModule ("OpacityMapVolumeStyle", "x_ite/Components/VolumeRendering/OpacityMapVolumeStyle", OpacityMapVolumeStyle_default_);
...
Namespace_default().addModule ("X3DVolumeRenderingContext", "x_ite/Browser/VolumeRendering/X3DVolumeRenderingContext", X3DVolumeRenderingContext_default_);
...
Namespace_default().addModule ("BlendedVolumeStyle", "x_ite/Components/VolumeRendering/BlendedVolumeStyle", BlendedVolumeStyle_default_);
...
Namespace_default().addModule ("BoundaryEnhancementVolumeStyle", "x_ite/Components/VolumeRendering/BoundaryEnhancementVolumeStyle", BoundaryEnhancementVolumeStyle_default_);
...
Namespace_default().addModule ("CartoonVolumeStyle", "x_ite/Components/VolumeRendering/CartoonVolumeStyle", CartoonVolumeStyle_default_);
...
Namespace_default().addModule ("ComposedVolumeStyle", "x_ite/Components/VolumeRendering/ComposedVolumeStyle", ComposedVolumeStyle_default_);
...
Namespace_default().addModule ("EdgeEnhancementVolumeStyle", "x_ite/Components/VolumeRendering/EdgeEnhancementVolumeStyle", EdgeEnhancementVolumeStyle_default_);
...
const TextureQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Browser/Core/TextureQuality");
...
const UnlitMaterial_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Shape/UnlitMaterial");
...
Namespace_default().addModule ("VolumeStyle.vs", "x_ite/Browser/VolumeRendering/VolumeStyle.vs", VolumeStyle_vs_default_);
...
Namespace_default().addModule ("VolumeStyle.fs", "x_ite/Browser/VolumeRendering/VolumeStyle.fs", VolumeStyle_fs_default_);
...
Namespace_default().addModule ("VolumeMaterial", "x_ite/Browser/VolumeRendering/VolumeMaterial", VolumeMaterial_default_);
...
Namespace_default().addModule ("X3DVolumeDataNode", "x_ite/Components/VolumeRendering/X3DVolumeDataNode", X3DVolumeDataNode_default_);
...
const ComposedShader_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Shaders/ComposedShader");
...
const ShaderPart_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Shaders/ShaderPart");
...
Namespace_default().addModule ("IsoSurfaceVolumeData", "x_ite/Components/VolumeRendering/IsoSurfaceVolumeData", IsoSurfaceVolumeData_default_);
...
Namespace_default().addModule ("ProjectionVolumeStyle", "x_ite/Components/VolumeRendering/ProjectionVolumeStyle", ProjectionVolumeStyle_default_);
...
Namespace_default().addModule ("SegmentedVolumeData", "x_ite/Components/VolumeRendering/SegmentedVolumeData", SegmentedVolumeData_default_);
...
Namespace_default().addModule ("ShadedVolumeStyle", "x_ite/Components/VolumeRendering/ShadedVolumeStyle", ShadedVolumeStyle_default_);
...
Namespace_default().addModule ("SilhouetteEnhancementVolumeStyle", "x_ite/Components/VolumeRendering/SilhouetteEnhancementVolumeStyle", SilhouetteEnhancementVolumeStyle_default_);
...
Namespace_default().addModule ("ToneMappedVolumeStyle", "x_ite/Components/VolumeRendering/ToneMappedVolumeStyle", ToneMappedVolumeStyle_default_);
...
Namespace_default().addModule ("VolumeData", "x_ite/Components/VolumeRendering/VolumeData", VolumeData_default_);
...
Namespace_default().addModule ("VolumeRendering", "assets/components/VolumeRendering", VolumeRendering_default_);
