...
const PixelTexture_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Components/Texturing/PixelTexture");
...
const TextureProperties_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Components/Texturing/TextureProperties");
...
const TextureQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Browser/Core/TextureQuality");
...
const UnlitMaterial_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Components/Shape/UnlitMaterial");
...
const ComposedShader_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Components/Shaders/ComposedShader");
...
const ShaderPart_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.0a")] .require ("x_ite/Components/Shaders/ShaderPart");
