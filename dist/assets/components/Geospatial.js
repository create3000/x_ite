...
const Inline_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Networking/Inline");
...
const X3DTransformMatrix3DNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Grouping/X3DTransformMatrix3DNode");
...
const X3DInterpolatorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Interpolation/X3DInterpolatorNode");
...
const X3DEnvironmentalSensorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/EnvironmentalSensor/X3DEnvironmentalSensorNode");
...
const ProximitySensor_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/EnvironmentalSensor/ProximitySensor");
...
const X3DTouchSensorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/PointingDeviceSensor/X3DTouchSensorNode");
...
const X3DViewpointNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Navigation/X3DViewpointNode");
...
const Viewpoint_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Navigation/Viewpoint");
...
const NavigationInfo_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.7.4")] .require ("x_ite/Components/Navigation/NavigationInfo");
