...
const X3DCoordinateNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Rendering/X3DCoordinateNode");
...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Rendering/X3DGeometryNode");
var X3DGeometryNode_default = /*#__PURE__*/__webpack_require__.n(X3DGeometryNode_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Numbers/Vector2\")"
const Vector2_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("standard/Math/Numbers/Vector2");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const OrientationInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Interpolation/OrientationInterpolator");
...
const PositionInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Interpolation/PositionInterpolator");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.0")] .require ("x_ite/Components/Geometry3D/Extrusion");
