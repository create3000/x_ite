...
const X3DCoordinateNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.3")] .require ("x_ite/Components/Rendering/X3DCoordinateNode");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.3")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.3")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.12.3")] .require ("x_ite/Components/Geometry3D/Extrusion");
