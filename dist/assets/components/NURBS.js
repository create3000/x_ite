...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.3")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.6.3")] .require ("x_ite/Components/Geometry3D/Extrusion");
