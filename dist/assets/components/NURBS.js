...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.0")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.0")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.0")] .require ("x_ite/Components/Geometry3D/Extrusion");
