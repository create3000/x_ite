...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const OrientationInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11")] .require ("x_ite/Components/Interpolation/OrientationInterpolator");
...
const PositionInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11")] .require ("x_ite/Components/Interpolation/PositionInterpolator");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.11")] .require ("x_ite/Components/Geometry3D/Extrusion");
