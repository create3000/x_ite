...
const OrientationInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.0")] .require ("x_ite/Components/Interpolation/OrientationInterpolator");
...
const PositionInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.0")] .require ("x_ite/Components/Interpolation/PositionInterpolator");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.3.0")] .require ("x_ite/Components/Geometry3D/Extrusion");
