...
const X3DCoordinateNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Rendering/X3DCoordinateNode");
...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Rendering/X3DGeometryNode");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const OrientationInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Interpolation/OrientationInterpolator");
...
const PositionInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Interpolation/PositionInterpolator");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.9.4")] .require ("x_ite/Components/Geometry3D/Extrusion");
