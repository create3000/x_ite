...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("x_ite/Components/Rendering/X3DGeometryNode");
var X3DGeometryNode_default = /*#__PURE__*/__webpack_require__.n(X3DGeometryNode_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Numbers/Vector2\")"
const Vector2_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("standard/Math/Numbers/Vector2");
var Vector2_default = /*#__PURE__*/__webpack_require__.n(Vector2_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Numbers/Vector4\")"
const Vector4_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("standard/Math/Numbers/Vector4");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.2.6")] .require ("x_ite/Components/Geometry3D/Extrusion");
