...
const X3DCoordinateNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("x_ite/Components/Rendering/X3DCoordinateNode");
...
const Vector4_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("standard/Math/Numbers/Vector4");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const OrientationInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("x_ite/Components/Interpolation/OrientationInterpolator");
...
const PositionInterpolator_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("x_ite/Components/Interpolation/PositionInterpolator");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.5.3")] .require ("x_ite/Components/Geometry3D/Extrusion");
