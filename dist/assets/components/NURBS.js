...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.0")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.0")] .require ("x_ite/Components/Geometry3D/Extrusion");
