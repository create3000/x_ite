...
const X3DNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("x_ite/Components/Core/X3DNode");
...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("x_ite/Components/Rendering/X3DGeometryNode");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const Triangle3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("standard/Math/Geometry/Triangle3");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("standard/Math/Geometry/Line3");
...
const Extrusion_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.3.0")] .require ("x_ite/Components/Geometry3D/Extrusion");
