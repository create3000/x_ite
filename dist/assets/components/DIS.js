...
const X3DInfoNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.5")] .require ("x_ite/Components/Core/X3DInfoNode");
...
const X3DSensorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.5")] .require ("x_ite/Components/Core/X3DSensorNode");
