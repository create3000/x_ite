...
const X3DAppearanceChildNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.4")] .require ("x_ite/Components/Shape/X3DAppearanceChildNode");
...
const X3DOneSidedMaterialNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-10.0.4")] .require ("x_ite/Components/Shape/X3DOneSidedMaterialNode");
