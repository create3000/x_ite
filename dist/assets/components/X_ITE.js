...
const X3DAppearanceChildNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Shape/X3DAppearanceChildNode");
...
Namespace_default().addModule ("BlendMode", "x_ite/Components/X_ITE/BlendMode", __default__);
...
Namespace_default().addModule ("X_ITE", "assets/components/X_ITE", X_ITE_default_);
