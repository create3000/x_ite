...
const X3DLightNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("x_ite/Components/Lighting/X3DLightNode");
...
const MatrixStack_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.4.4")] .require ("standard/Math/Utility/MatrixStack");
