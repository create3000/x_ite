...
const X3DLightNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.1")] .require ("x_ite/Components/Lighting/X3DLightNode");
...
const MatrixStack_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.1")] .require ("standard/Math/Utility/MatrixStack");
...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.1.1")] .require ("standard/Utility/ObjectCache");
