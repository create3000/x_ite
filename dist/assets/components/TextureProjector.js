...
Namespace_default().addModule ("X3DTextureProjectorNode", "x_ite/Components/TextureProjector/X3DTextureProjectorNode", __default__);
...
Namespace_default().addModule ("TextureProjector", "x_ite/Components/TextureProjector/TextureProjector", TextureProjector_default_);
...
Namespace_default().addModule ("TextureProjectorParallel", "x_ite/Components/TextureProjector/TextureProjectorParallel", TextureProjectorParallel_default_);
...
Namespace_default().addModule ("TextureProjector", "assets/components/TextureProjector", components_TextureProjector_default_);
