...
const X3DLayerNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.7a")] .require ("x_ite/Components/Layering/X3DLayerNode");
...
const OrthoViewpoint_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.7a")] .require ("x_ite/Components/Navigation/OrthoViewpoint");
...
const X3DFontStyleNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.7a")] .require ("x_ite/Components/Text/X3DFontStyleNode");
...
const X3DTextGeometry_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.7a")] .require ("x_ite/Browser/Text/X3DTextGeometry");
...
const TextAlignment_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.6.7a")] .require ("x_ite/Browser/Text/TextAlignment");
