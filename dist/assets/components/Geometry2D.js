...
const Complex_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.2")] .require ("standard/Math/Numbers/Complex");
...
const TextureCoordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.2")] .require ("x_ite/Components/Texturing/TextureCoordinate");
...
const X3DPointGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-9.5.2")] .require ("x_ite/Components/Rendering/X3DPointGeometryNode");
