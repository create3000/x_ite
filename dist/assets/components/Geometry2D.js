...
Namespace_default().addModule ("Arc2DOptions", "x_ite/Browser/Geometry2D/Arc2DOptions", __default__);
...
Namespace_default().addModule ("ArcClose2DOptions", "x_ite/Browser/Geometry2D/ArcClose2DOptions", ArcClose2DOptions_default_);
...
const Complex_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("standard/Math/Numbers/Complex");
...
Namespace_default().addModule ("Circle2DOptions", "x_ite/Browser/Geometry2D/Circle2DOptions", Circle2DOptions_default_);
...
Namespace_default().addModule ("Disk2DOptions", "x_ite/Browser/Geometry2D/Disk2DOptions", Disk2DOptions_default_);
...
const Coordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Rendering/Coordinate");
...
const TextureCoordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Texturing/TextureCoordinate");
...
Namespace_default().addModule ("Rectangle2DOptions", "x_ite/Browser/Geometry2D/Rectangle2DOptions", Rectangle2DOptions_default_);
...
Namespace_default().addModule ("X3DGeometry2DContext", "x_ite/Browser/Geometry2D/X3DGeometry2DContext", X3DGeometry2DContext_default_);
...
Namespace_default().addModule ("Arc2D", "x_ite/Components/Geometry2D/Arc2D", Arc2D_default_);
...
Namespace_default().addModule ("ArcClose2D", "x_ite/Components/Geometry2D/ArcClose2D", ArcClose2D_default_);
...
Namespace_default().addModule ("Circle2D", "x_ite/Components/Geometry2D/Circle2D", Circle2D_default_);
...
const X3DPointGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D-8.11.16")] .require ("x_ite/Components/Rendering/X3DPointGeometryNode");
...
Namespace_default().addModule ("Disk2D", "x_ite/Components/Geometry2D/Disk2D", Disk2D_default_);
...
Namespace_default().addModule ("Polyline2D", "x_ite/Components/Geometry2D/Polyline2D", Polyline2D_default_);
...
Namespace_default().addModule ("Polypoint2D", "x_ite/Components/Geometry2D/Polypoint2D", Polypoint2D_default_);
...
Namespace_default().addModule ("Rectangle2D", "x_ite/Components/Geometry2D/Rectangle2D", Rectangle2D_default_);
...
Namespace_default().addModule ("TriangleSet2D", "x_ite/Components/Geometry2D/TriangleSet2D", TriangleSet2D_default_);
...
Namespace_default().addModule ("Geometry2D", "assets/components/Geometry2D", Geometry2D_default_);
