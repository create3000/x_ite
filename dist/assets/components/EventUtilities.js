...
Namespace_default().addModule ("BooleanFilter", "x_ite/Components/EventUtilities/BooleanFilter", __default__);
...
Namespace_default().addModule ("X3DSequencerNode", "x_ite/Components/EventUtilities/X3DSequencerNode", X3DSequencerNode_default_);
...
Namespace_default().addModule ("BooleanSequencer", "x_ite/Components/EventUtilities/BooleanSequencer", BooleanSequencer_default_);
...
Namespace_default().addModule ("BooleanToggle", "x_ite/Components/EventUtilities/BooleanToggle", BooleanToggle_default_);
...
Namespace_default().addModule ("X3DTriggerNode", "x_ite/Components/EventUtilities/X3DTriggerNode", X3DTriggerNode_default_);
...
Namespace_default().addModule ("BooleanTrigger", "x_ite/Components/EventUtilities/BooleanTrigger", BooleanTrigger_default_);
...
Namespace_default().addModule ("IntegerSequencer", "x_ite/Components/EventUtilities/IntegerSequencer", IntegerSequencer_default_);
...
Namespace_default().addModule ("IntegerTrigger", "x_ite/Components/EventUtilities/IntegerTrigger", IntegerTrigger_default_);
...
Namespace_default().addModule ("TimeTrigger", "x_ite/Components/EventUtilities/TimeTrigger", TimeTrigger_default_);
...
Namespace_default().addModule ("EventUtilities", "assets/components/EventUtilities", EventUtilities_default_);
