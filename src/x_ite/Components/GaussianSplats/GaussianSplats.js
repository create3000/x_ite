...
Object .defineProperties (GaussianSplats,
{
   ...
   fieldDefinitions:
   {
      value: new FieldDefinitionArray ([
         ...
         new X3DFieldDefinition (X3DConstants .inputOutput,    "pointerEvents",                  new Fields .SFBool ()),
         new X3DFieldDefinition (X3DConstants .inputOutput,    "castShadow",                     new Fields .SFBool ()),
