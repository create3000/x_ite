...
Object .defineProperties (HAnimJoint,
{
   ...
   fieldDefinitions:
   {
      value: new FieldDefinitionArray ([
         ...
         new X3DFieldDefinition (X3DConstants .inputOutput,    "minAngle",         new Fields .SFFloat (0)),
         new X3DFieldDefinition (X3DConstants .inputOutput,    "maxAngle",         new Fields .SFFloat (0)),
