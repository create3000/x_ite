...
Object .defineProperties (HAnimJoint,
{
   ...
   fieldDefinitions:
   {
      value: new FieldDefinitionArray ([
         ...
         new X3DFieldDefinition (X3DConstants .inputOutput,    "llimit",           new Fields .MFFloat (new Vector3 (0, 0, 0))),
         new X3DFieldDefinition (X3DConstants .inputOutput,    "ulimit",           new Fields .MFFloat (new Vector3 (0, 0, 0))),
