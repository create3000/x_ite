...
const orientationMatrices = [
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .X_AXIS,          Vector3 .Z_AXIS)), // left
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .NEGATIVE_X_AXIS, Vector3 .Z_AXIS)), // right
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .NEGATIVE_Z_AXIS, Vector3 .Z_AXIS)), // front
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .Z_AXIS,          Vector3 .Z_AXIS)), // back
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .Y_AXIS,          Vector3 .Z_AXIS)), // bottom
   Matrix4 .fromRotation (Rotation4 .fromVectors (Vector3 .NEGATIVE_Y_AXIS, Vector3 .Z_AXIS)), // top
];
