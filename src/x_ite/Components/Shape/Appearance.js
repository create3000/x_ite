...
Appearance .prototype = Object .assign (Object .create (X3DAppearanceNode .prototype),
{
   ...
   initialize: function ()
   {
      ...
      browser .getRenderingProperties () ._ContentScale .addInterest ("set_pointProperties__", this);
      browser .getRenderingProperties () ._ContentScale .addInterest ("set_applied__",         this);
   ...
   set_pointProperties__: function ()
   {
      ...
      if (! this .stylePropertiesNode [0] && browser .getRenderingProperty ("ContentScale") !== 1)
   ...
   set_applied__: function ()
   {
      ...
      if (this .linePropertiesNode && this .linePropertiesNode ._applied .getValue ())
         ...
         this .stylePropertiesNode [1] = browser .getRenderingProperty ("ContentScale") !== 1 ? browser .getDefaultLineProperties () : null;
   },
