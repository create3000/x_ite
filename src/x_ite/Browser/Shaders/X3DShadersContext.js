...
Object .assign (X3DShadersContext .prototype,
{
   ...
   createShader (name, vs, fs = vs, options = [ ], uniformNames = [ ], transformFeedbackVaryings = [ ])
   {
      ...
      vertexShader ._url .push (encodeURI (vs .startsWith ("data:") ? vs : "data:x-shader/x-vertex-x_ite," + Shaders .vertex [version] [vs]));
      ...
      fragmentShader ._url .push (encodeURI (fs .startsWith ("data:") ? fs : "data:x-shader/x-fragment-x_ite," + Shaders .fragment [version] [fs]));
