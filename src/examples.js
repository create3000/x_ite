const X_ITE_EXAMPLES = [
   ...
   { component: "CubeMapTexturing", test: "ComposedCubeMapTexture", xrMovementControl: "VIEWPOINT" },
   { component: "CubeMapTexturing", test: "GeneratedCubeMapTexture", xrMovementControl: "VIEWPOINT" },
   ...
   { component: "Navigation", test: "LogarithmicDepthBuffer", xrMovementControl: "VIEWPOINT" },
   { component: "Navigation", test: "NavigationInfo" },
   { component: "Navigation", test: "OrthoViewpoint" },
   { component: "Navigation", test: "Viewpoint", xrMovementControl: "VIEWPOINT" },
   ...
   { component: "ParticleSystems", test: "ParticleSystem", xrMovementControl: "VIEWPOINT" },
   ...
   { component: "X3D", test: "Circles", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "CrazySpiral", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "Currencies", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "FlashingLights", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "FoldUp" },
   { component: "X3D", test: "LogoPieces" },
   { component: "X3D", test: "LustForLife", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "MagicMushrooms" },
   { component: "X3D", test: "MilkyWayAndBeyond", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "NYC" },
   { component: "X3D", test: "Pong", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "SecretLabyrinth" },
   { component: "X3D", test: "SlidingPuzzle", xrButtonPosition: "tl", xrMovementControl: "VIEWPOINT" },
   ...
   { component: "X3D", test: "TikiWorld", xrMovementControl: "VIEWPOINT" },
   { component: "X3D", test: "TreasureIsland" },
   { component: "X3D", test: "Vattenfall", xrMovementControl: "VIEWPOINT" },
