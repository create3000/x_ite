const X_ITE_TESTS = [
   ...
   { component: "GaussianSplats" },
   { path: "GaussianSplats/cactus_splat3_30kSteps_142k_splats.ply" },
   { path: "GaussianSplats/unitCube-ascii.ply" },
   ...
   { path: "Lighting/GeneratedEvironmentLight.x3d" },
   ...
   { path: "ParticleSystems/FireWithoutShadows.x3d" },
   ...
   { path: "ParticleSystems/Scales.x3d" },
   ...
   { path: "Texturing/KTXCubeMap.x3d" },
   { path: "Texturing/MirrorBox.x3d" },
   ...
   { path: "Texturing/RenderedTexture.x3d" },
