...
float
getPerceivedBrightness (const in vec3 color)
{
...
float
solveMetallic (const in float diffuse, const in float specular, const in float oneMinusSpecularStrength, const in float dielectricSpecular)
{
