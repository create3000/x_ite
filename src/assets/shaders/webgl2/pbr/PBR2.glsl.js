...
#if defined (X3D_TRANSMISSION_MATERIAL_EXT) || (defined (X3D_DIFFUSE_TRANSMISSION_MATERIAL_EXT) && defined (X3D_VOLUME_MATERIAL_EXT)) || defined (X3D_VOLUME_SCATTER_MATERIAL_EXT)
