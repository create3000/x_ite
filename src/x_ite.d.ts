...
declare namespace X3D
{
   ...
   class X3DConstants
   {
      ...
      static readonly CONNECTION_ERROR: number;
      static readonly BROWSER_EVENT: number;
      static readonly INITIALIZED_EVENT: number;
      static readonly SHUTDOWN_EVENT: number;
      static readonly INITIALIZED_ERROR: number;

      // Load State Constants

      static readonly NOT_STARTED_STATE: number;
      static readonly IN_PROGRESS_STATE: number;
      static readonly COMPLETE_STATE: number;
      static readonly FAILED_STATE: number;

      // Access Type Constants

      static readonly initializeOnly: 0b001;
      static readonly inputOnly: 0b010;
      static readonly outputOnly: 0b100;
      static readonly inputOutput: 0b111;

      // Field Type Constants

      static readonly SFBool: number;
      static readonly SFColor: number;
      static readonly SFColorRGBA: number;
      static readonly SFDouble: number;
      static readonly SFFloat: number;
      static readonly SFImage: number;
      static readonly SFInt32: number;
      static readonly SFMatrix3d: number;
      static readonly SFMatrix3f: number;
      static readonly SFMatrix4d: number;
      static readonly SFMatrix4f: number;
      static readonly SFNode: number;
      static readonly SFRotation: number;
      static readonly SFString: number;
      static readonly SFTime: number;
      static readonly SFVec2d: number;
      static readonly SFVec2f: number;
      static readonly SFVec3d: number;
      static readonly SFVec3f: number;
      static readonly SFVec4d: number;
      static readonly SFVec4f: number;

      static readonly MFBool: number;
      static readonly MFColor: number;
      static readonly MFColorRGBA: number;
      static readonly MFDouble: number;
      static readonly MFFloat: number;
      static readonly MFImage: number;
      static readonly MFInt32: number;
      static readonly MFMatrix3d: number;
      static readonly MFMatrix3f: number;
      static readonly MFMatrix4d: number;
      static readonly MFMatrix4f: number;
      static readonly MFNode: number;
      static readonly MFRotation: number;
      static readonly MFString: number;
      static readonly MFTime: number;
      static readonly MFVec2d: number;
      static readonly MFVec2f: number;
      static readonly MFVec3d: number;
      static readonly MFVec3f: number;
      static readonly MFVec4d: number;
      static readonly MFVec4f: number;
      ...
      static readonly AcousticProperties: number;
      static readonly Analyser: number;
      static readonly Anchor: number;
      static readonly AnisotropyMaterialExtension: number;
      static readonly Appearance: number;
      static readonly Arc2D: number;
      static readonly ArcClose2D: number;
      static readonly AudioClip: number;
      static readonly AudioDestination: number;
      static readonly Background: number;
      static readonly BallJoint: number;
      static readonly Billboard: number;
      static readonly BiquadFilter: number;
      static readonly BlendedVolumeStyle: number;
      static readonly BlendMode: number;
      static readonly BooleanFilter: number;
      static readonly BooleanSequencer: number;
      static readonly BooleanToggle: number;
      static readonly BooleanTrigger: number;
      static readonly BoundaryEnhancementVolumeStyle: number;
      static readonly BoundedPhysicsModel: number;
      static readonly Box: number;
      static readonly BufferAudioSource: number;
      static readonly CADAssembly: number;
      static readonly CADFace: number;
      static readonly CADLayer: number;
      static readonly CADPart: number;
      static readonly CartoonVolumeStyle: number;
      static readonly ChannelMerger: number;
      static readonly ChannelSelector: number;
      static readonly ChannelSplitter: number;
      static readonly Circle2D: number;
      static readonly ClearcoatMaterialExtension: number;
      static readonly ClipPlane: number;
      static readonly CollidableOffset: number;
      static readonly CollidableShape: number;
      static readonly Collision: number;
      static readonly CollisionCollection: number;
      static readonly CollisionSensor: number;
      static readonly CollisionSpace: number;
      static readonly Color: number;
      static readonly ColorChaser: number;
      static readonly ColorDamper: number;
      static readonly ColorInterpolator: number;
      static readonly ColorRGBA: number;
      static readonly ComposedCubeMapTexture: number;
      static readonly ComposedShader: number;
      static readonly ComposedTexture3D: number;
      static readonly ComposedVolumeStyle: number;
      static readonly Cone: number;
      static readonly ConeEmitter: number;
      static readonly Contact: number;
      static readonly Contour2D: number;
      static readonly ContourPolyline2D: number;
      static readonly Convolver: number;
      static readonly Coordinate: number;
      static readonly CoordinateChaser: number;
      static readonly CoordinateDamper: number;
      static readonly CoordinateDouble: number;
      static readonly CoordinateInterpolator: number;
      static readonly CoordinateInterpolator2D: number;
      static readonly Cylinder: number;
      static readonly CylinderSensor: number;
      static readonly Delay: number;
      static readonly DepthMode: number;
      static readonly DiffuseTransmissionMaterialExtension: number;
      static readonly DirectionalLight: number;
      static readonly DISEntityManager: number;
      static readonly DISEntityTypeMapping: number;
      static readonly Disk2D: number;
      static readonly DispersionMaterialExtension: number;
      static readonly DoubleAxisHingeJoint: number;
      static readonly DynamicsCompressor: number;
      static readonly EaseInEaseOut: number;
      static readonly EdgeEnhancementVolumeStyle: number;
      static readonly ElevationGrid: number;
      static readonly EmissiveStrengthMaterialExtension: number;
      static readonly EnvironmentLight: number;
      static readonly EspduTransform: number;
      static readonly ExplosionEmitter: number;
      static readonly Extrusion: number;
      static readonly FillProperties: number;
      static readonly FloatVertexAttribute: number;
      static readonly Fog: number;
      static readonly FogCoordinate: number;
      static readonly FontStyle: number;
      static readonly ForcePhysicsModel: number;
      static readonly Gain: number;
      static readonly GeneratedCubeMapTexture: number;
      static readonly GeoCoordinate: number;
      static readonly GeoElevationGrid: number;
      static readonly GeoLocation: number;
      static readonly GeoLOD: number;
      static readonly GeoMetadata: number;
      static readonly GeoOrigin: number;
      static readonly GeoPositionInterpolator: number;
      static readonly GeoProximitySensor: number;
      static readonly GeoTouchSensor: number;
      static readonly GeoTransform: number;
      static readonly GeoViewpoint: number;
      static readonly Group: number;
      static readonly HAnimDisplacer: number;
      static readonly HAnimHumanoid: number;
      static readonly HAnimJoint: number;
      static readonly HAnimMotion: number;
      static readonly HAnimSegment: number;
      static readonly HAnimSite: number;
      static readonly ImageCubeMapTexture: number;
      static readonly ImageTexture: number;
      static readonly ImageTexture3D: number;
      static readonly ImageTextureAtlas: number;
      static readonly IndexedFaceSet: number;
      static readonly IndexedLineSet: number;
      static readonly IndexedQuadSet: number;
      static readonly IndexedTriangleFanSet: number;
      static readonly IndexedTriangleSet: number;
      static readonly IndexedTriangleStripSet: number;
      static readonly Inline: number;
      static readonly InstancedShape: number;
      static readonly IntegerSequencer: number;
      static readonly IntegerTrigger: number;
      static readonly IORMaterialExtension: number;
      static readonly IridescenceMaterialExtension: number;
      static readonly IsoSurfaceVolumeData: number;
      static readonly KeySensor: number;
      static readonly Layer: number;
      static readonly LayerSet: number;
      static readonly Layout: number;
      static readonly LayoutGroup: number;
      static readonly LayoutLayer: number;
      static readonly LinePickSensor: number;
      static readonly LineProperties: number;
      static readonly LineSet: number;
      static readonly ListenerPointSource: number;
      static readonly LoadSensor: number;
      static readonly LocalFog: number;
      static readonly LOD: number;
      static readonly Material: number;
      static readonly Matrix3VertexAttribute: number;
      static readonly Matrix4VertexAttribute: number;
      static readonly MetadataBoolean: number;
      static readonly MetadataDouble: number;
      static readonly MetadataFloat: number;
      static readonly MetadataInteger: number;
      static readonly MetadataSet: number;
      static readonly MetadataString: number;
      static readonly MicrophoneSource: number;
      static readonly MotorJoint: number;
      static readonly MovieTexture: number;
      static readonly MultiTexture: number;
      static readonly MultiTextureCoordinate: number;
      static readonly MultiTextureTransform: number;
      static readonly NavigationInfo: number;
      static readonly Normal: number;
      static readonly NormalInterpolator: number;
      static readonly NurbsCurve: number;
      static readonly NurbsCurve2D: number;
      static readonly NurbsOrientationInterpolator: number;
      static readonly NurbsPatchSurface: number;
      static readonly NurbsPositionInterpolator: number;
      static readonly NurbsSet: number;
      static readonly NurbsSurfaceInterpolator: number;
      static readonly NurbsSweptSurface: number;
      static readonly NurbsSwungSurface: number;
      static readonly NurbsTextureCoordinate: number;
      static readonly NurbsTrimmedSurface: number;
      static readonly OpacityMapVolumeStyle: number;
      static readonly OrientationChaser: number;
      static readonly OrientationDamper: number;
      static readonly OrientationInterpolator: number;
      static readonly OrthoViewpoint: number;
      static readonly OscillatorSource: number;
      static readonly PackagedShader: number;
      static readonly ParticleSystem: number;
      static readonly PeriodicWave: number;
      static readonly PhysicalMaterial: number;
      static readonly PickableGroup: number;
      static readonly PixelTexture: number;
      static readonly PixelTexture3D: number;
      static readonly PlaneSensor: number;
      static readonly PointEmitter: number;
      static readonly PointLight: number;
      static readonly PointPickSensor: number;
      static readonly PointProperties: number;
      static readonly PointSet: number;
      static readonly Polyline2D: number;
      static readonly PolylineEmitter: number;
      static readonly Polypoint2D: number;
      static readonly PositionChaser: number;
      static readonly PositionChaser2D: number;
      static readonly PositionDamper: number;
      static readonly PositionDamper2D: number;
      static readonly PositionInterpolator: number;
      static readonly PositionInterpolator2D: number;
      static readonly PrimitivePickSensor: number;
      static readonly ProgramShader: number;
      static readonly ProjectionVolumeStyle: number;
      static readonly ProximitySensor: number;
      static readonly QuadSet: number;
      static readonly ReceiverPdu: number;
      static readonly Rectangle2D: number;
      static readonly RigidBody: number;
      static readonly RigidBodyCollection: number;
      static readonly ScalarChaser: number;
      static readonly ScalarDamper: number;
      static readonly ScalarInterpolator: number;
      static readonly ScreenFontStyle: number;
      static readonly ScreenGroup: number;
      static readonly Script: number;
      static readonly SegmentedVolumeData: number;
      static readonly ShadedVolumeStyle: number;
      static readonly ShaderPart: number;
      static readonly ShaderProgram: number;
      static readonly Shape: number;
      static readonly SheenMaterialExtension: number;
      static readonly SignalPdu: number;
      static readonly SilhouetteEnhancementVolumeStyle: number;
      static readonly SingleAxisHingeJoint: number;
      static readonly SliderJoint: number;
      static readonly Sound: number;
      static readonly SpatialSound: number;
      static readonly SpecularGlossinessMaterial: number;
      static readonly SpecularMaterialExtension: number;
      static readonly Sphere: number;
      static readonly SphereSensor: number;
      static readonly SplinePositionInterpolator: number;
      static readonly SplinePositionInterpolator2D: number;
      static readonly SplineScalarInterpolator: number;
      static readonly SpotLight: number;
      static readonly SquadOrientationInterpolator: number;
      static readonly StaticGroup: number;
      static readonly StreamAudioDestination: number;
      static readonly StreamAudioSource: number;
      static readonly StringSensor: number;
      static readonly SurfaceEmitter: number;
      static readonly Switch: number;
      static readonly Tangent: number;
      static readonly TexCoordChaser2D: number;
      static readonly TexCoordDamper2D: number;
      static readonly Text: number;
      static readonly TextureBackground: number;
      static readonly TextureCoordinate: number;
      static readonly TextureCoordinate3D: number;
      static readonly TextureCoordinate4D: number;
      static readonly TextureCoordinateGenerator: number;
      static readonly TextureProjector: number;
      static readonly TextureProjectorParallel: number;
      static readonly TextureProperties: number;
      static readonly TextureTransform: number;
      static readonly TextureTransform3D: number;
      static readonly TextureTransformMatrix3D: number;
      static readonly TimeSensor: number;
      static readonly TimeTrigger: number;
      static readonly ToneMappedVolumeStyle: number;
      static readonly TouchSensor: number;
      static readonly Transform: number;
      static readonly TransformSensor: number;
      static readonly TransmissionMaterialExtension: number;
      static readonly TransmitterPdu: number;
      static readonly TriangleFanSet: number;
      static readonly TriangleSet: number;
      static readonly TriangleSet2D: number;
      static readonly TriangleStripSet: number;
      static readonly TwoSidedMaterial: number;
      static readonly UniversalJoint: number;
      static readonly UnlitMaterial: number;
      static readonly Viewpoint: number;
      static readonly ViewpointGroup: number;
      static readonly Viewport: number;
      static readonly VisibilitySensor: number;
      static readonly VolumeData: number;
      static readonly VolumeEmitter: number;
      static readonly VolumeMaterialExtension: number;
      static readonly VolumePickSensor: number;
      static readonly WaveShaper: number;
      static readonly WindPhysicsModel: number;
      static readonly WorldInfo: number;
      ...
      static readonly X3DAppearanceChildNode: number;
      static readonly X3DAppearanceNode: number;
      static readonly X3DBackgroundNode: number;
      static readonly X3DBindableNode: number;
      static readonly X3DBoundedObject: number;
      static readonly X3DChaserNode: number;
      static readonly X3DChildNode: number;
      static readonly X3DColorNode: number;
      static readonly X3DComposableVolumeRenderStyleNode: number;
      static readonly X3DComposedGeometryNode: number;
      static readonly X3DCoordinateNode: number;
      static readonly X3DDamperNode: number;
      static readonly X3DDragSensorNode: number;
      static readonly X3DEnvironmentalSensorNode: number;
      static readonly X3DEnvironmentTextureNode: number;
      static readonly X3DFogObject: number;
      static readonly X3DFollowerNode: number;
      static readonly X3DFontStyleNode: number;
      static readonly X3DGeometricPropertyNode: number;
      static readonly X3DGeometryNode: number;
      static readonly X3DGroupingNode: number;
      static readonly X3DInfoNode: number;
      static readonly X3DInterpolatorNode: number;
      static readonly X3DKeyDeviceSensorNode: number;
      static readonly X3DLayerNode: number;
      static readonly X3DLayoutNode: number;
      static readonly X3DLightNode: number;
      static readonly X3DMaterialExtensionNode: number;
      static readonly X3DMaterialNode: number;
      static readonly X3DMetadataObject: number;
      static readonly X3DNBodyCollidableNode: number;
      static readonly X3DNBodyCollisionSpaceNode: number;
      static readonly X3DNetworkSensorNode: number;
      static readonly X3DNode: number;
      static readonly X3DNormalNode: number;
      static readonly X3DNurbsControlCurveNode: number;
      static readonly X3DNurbsSurfaceGeometryNode: number;
      static readonly X3DOneSidedMaterialNode: number;
      static readonly X3DParametricGeometryNode: number;
      static readonly X3DParticleEmitterNode: number;
      static readonly X3DParticlePhysicsModelNode: number;
      static readonly X3DPickableObject: number;
      static readonly X3DPickSensorNode: number;
      static readonly X3DPointingDeviceSensorNode: number;
      static readonly X3DProductStructureChildNode: number;
      static readonly X3DProgrammableShaderObject: number;
      static readonly X3DPrototypeInstance: number;
      static readonly X3DRigidJointNode: number;
      static readonly X3DScriptNode: number;
      static readonly X3DSensorNode: number;
      static readonly X3DSequencerNode: number;
      static readonly X3DShaderNode: number;
      static readonly X3DShapeNode: number;
      static readonly X3DSingleTextureCoordinateNode: number;
      static readonly X3DSingleTextureNode: number;
      static readonly X3DSingleTextureTransformNode: number;
      static readonly X3DSoundChannelNode: number;
      static readonly X3DSoundDestinationNode: number;
      static readonly X3DSoundNode: number;
      static readonly X3DSoundProcessingNode: number;
      static readonly X3DSoundSourceNode: number;
      static readonly X3DStatement: number;
      static readonly X3DTexture2DNode: number;
      static readonly X3DTexture3DNode: number;
      static readonly X3DTextureCoordinateNode: number;
      static readonly X3DTextureNode: number;
      static readonly X3DTextureProjectorNode: number;
      static readonly X3DTextureTransformNode: number;
      static readonly X3DTimeDependentNode: number;
      static readonly X3DTouchSensorNode: number;
      static readonly X3DTriggerNode: number;
      static readonly X3DUrlObject: number;
      static readonly X3DVertexAttributeNode: number;
      static readonly X3DViewpointNode: number;
      static readonly X3DViewportNode: number;
      static readonly X3DVolumeDataNode: number;
      static readonly X3DVolumeRenderStyleNode: number;
