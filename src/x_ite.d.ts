...
declare class X3DBrowser
{
   ...
   addBrowserCallback (key: any, callback?: (event: BrowserEvents) => void): void;
   addBrowserCallback (key: any, event: BrowserEvents, callback?: (event: number) => void): void;
...
type BrowserEvents = X3DConstants ["CONNECTION_ERROR"]
   | X3DConstants ["BROWSER_EVENT"]
   | X3DConstants ["INITIALIZED_EVENT"]
   | X3DConstants ["SHUTDOWN_EVENT"]
   | X3DConstants ["INITIALIZED_ERROR"];

type LoadStates = X3DConstants ["NOT_STARTED_STATE"]
   | X3DConstants ["IN_PROGRESS_STATE"]
   | X3DConstants ["COMPLETE_STATE"]
   | X3DConstants ["FAILED_STATE"];

type AccessTypes = X3DConstants ["initializeOnly"]
   | X3DConstants ["inputOnly"]
   | X3DConstants ["outputOnly"]
   | X3DConstants ["inputOutput"];

type FieldTypes = X3DConstants ["SFBool"]
   | X3DConstants ["SFColor"]
   | X3DConstants ["SFColorRGBA"]
   | X3DConstants ["SFDouble"]
   | X3DConstants ["SFFloat"]
   | X3DConstants ["SFImage"]
   | X3DConstants ["SFInt32"]
   | X3DConstants ["SFMatrix3d"]
   | X3DConstants ["SFMatrix3f"]
   | X3DConstants ["SFMatrix4d"]
   | X3DConstants ["SFMatrix4f"]
   | X3DConstants ["SFNode"]
   | X3DConstants ["SFRotation"]
   | X3DConstants ["SFString"]
   | X3DConstants ["SFTime"]
   | X3DConstants ["SFVec2d"]
   | X3DConstants ["SFVec2f"]
   | X3DConstants ["SFVec3d"]
   | X3DConstants ["SFVec3f"]
   | X3DConstants ["SFVec4d"]
   | X3DConstants ["SFVec4f"]
   | X3DConstants ["MFBool"]
   | X3DConstants ["MFColor"]
   | X3DConstants ["MFColorRGBA"]
   | X3DConstants ["MFDouble"]
   | X3DConstants ["MFFloat"]
   | X3DConstants ["MFImage"]
   | X3DConstants ["MFInt32"]
   | X3DConstants ["MFMatrix3d"]
   | X3DConstants ["MFMatrix3f"]
   | X3DConstants ["MFMatrix4d"]
   | X3DConstants ["MFMatrix4f"]
   | X3DConstants ["MFNode"]
   | X3DConstants ["MFRotation"]
   | X3DConstants ["MFString"]
   | X3DConstants ["MFTime"]
   | X3DConstants ["MFVec2d"]
   | X3DConstants ["MFVec2f"]
   | X3DConstants ["MFVec3d"]
   | X3DConstants ["MFVec3f"]
   | X3DConstants ["MFVec4d"]
   | X3DConstants ["MFVec4f"];

// TYPE NODE TYPES START

type NodeTypes = X3DConstants ["AcousticProperties"]
   | X3DConstants ["Analyser"]
   | X3DConstants ["Anchor"]
   | X3DConstants ["Appearance"]
   | X3DConstants ["Arc2D"]
   | X3DConstants ["ArcClose2D"]
   | X3DConstants ["AudioClip"]
   | X3DConstants ["AudioDestination"]
   | X3DConstants ["Background"]
   | X3DConstants ["BallJoint"]
   | X3DConstants ["Billboard"]
   | X3DConstants ["BiquadFilter"]
   | X3DConstants ["BlendedVolumeStyle"]
   | X3DConstants ["BlendMode"]
   | X3DConstants ["BooleanFilter"]
   | X3DConstants ["BooleanSequencer"]
   | X3DConstants ["BooleanToggle"]
   | X3DConstants ["BooleanTrigger"]
   | X3DConstants ["BoundaryEnhancementVolumeStyle"]
   | X3DConstants ["BoundedPhysicsModel"]
   | X3DConstants ["Box"]
   | X3DConstants ["BufferAudioSource"]
   | X3DConstants ["CADAssembly"]
   | X3DConstants ["CADFace"]
   | X3DConstants ["CADLayer"]
   | X3DConstants ["CADPart"]
   | X3DConstants ["CartoonVolumeStyle"]
   | X3DConstants ["ChannelMerger"]
   | X3DConstants ["ChannelSelector"]
   | X3DConstants ["ChannelSplitter"]
   | X3DConstants ["Circle2D"]
   | X3DConstants ["ClipPlane"]
   | X3DConstants ["CollidableOffset"]
   | X3DConstants ["CollidableShape"]
   | X3DConstants ["Collision"]
   | X3DConstants ["CollisionCollection"]
   | X3DConstants ["CollisionSensor"]
   | X3DConstants ["CollisionSpace"]
   | X3DConstants ["Color"]
   | X3DConstants ["ColorChaser"]
   | X3DConstants ["ColorDamper"]
   | X3DConstants ["ColorInterpolator"]
   | X3DConstants ["ColorRGBA"]
   | X3DConstants ["ComposedCubeMapTexture"]
   | X3DConstants ["ComposedShader"]
   | X3DConstants ["ComposedTexture3D"]
   | X3DConstants ["ComposedVolumeStyle"]
   | X3DConstants ["Cone"]
   | X3DConstants ["ConeEmitter"]
   | X3DConstants ["Contact"]
   | X3DConstants ["Contour2D"]
   | X3DConstants ["ContourPolyline2D"]
   | X3DConstants ["Convolver"]
   | X3DConstants ["Coordinate"]
   | X3DConstants ["CoordinateChaser"]
   | X3DConstants ["CoordinateDamper"]
   | X3DConstants ["CoordinateDouble"]
   | X3DConstants ["CoordinateInterpolator"]
   | X3DConstants ["CoordinateInterpolator2D"]
   | X3DConstants ["Cylinder"]
   | X3DConstants ["CylinderSensor"]
   | X3DConstants ["Delay"]
   | X3DConstants ["DepthMode"]
   | X3DConstants ["DirectionalLight"]
   | X3DConstants ["DISEntityManager"]
   | X3DConstants ["DISEntityTypeMapping"]
   | X3DConstants ["Disk2D"]
   | X3DConstants ["DoubleAxisHingeJoint"]
   | X3DConstants ["DynamicsCompressor"]
   | X3DConstants ["EaseInEaseOut"]
   | X3DConstants ["EdgeEnhancementVolumeStyle"]
   | X3DConstants ["ElevationGrid"]
   | X3DConstants ["EspduTransform"]
   | X3DConstants ["ExplosionEmitter"]
   | X3DConstants ["Extrusion"]
   | X3DConstants ["FillProperties"]
   | X3DConstants ["FloatVertexAttribute"]
   | X3DConstants ["Fog"]
   | X3DConstants ["FogCoordinate"]
   | X3DConstants ["FontStyle"]
   | X3DConstants ["ForcePhysicsModel"]
   | X3DConstants ["Gain"]
   | X3DConstants ["GeneratedCubeMapTexture"]
   | X3DConstants ["GeoCoordinate"]
   | X3DConstants ["GeoElevationGrid"]
   | X3DConstants ["GeoLocation"]
   | X3DConstants ["GeoLOD"]
   | X3DConstants ["GeoMetadata"]
   | X3DConstants ["GeoOrigin"]
   | X3DConstants ["GeoPositionInterpolator"]
   | X3DConstants ["GeoProximitySensor"]
   | X3DConstants ["GeoTouchSensor"]
   | X3DConstants ["GeoTransform"]
   | X3DConstants ["GeoViewpoint"]
   | X3DConstants ["Group"]
   | X3DConstants ["HAnimDisplacer"]
   | X3DConstants ["HAnimHumanoid"]
   | X3DConstants ["HAnimJoint"]
   | X3DConstants ["HAnimMotion"]
   | X3DConstants ["HAnimSegment"]
   | X3DConstants ["HAnimSite"]
   | X3DConstants ["ImageCubeMapTexture"]
   | X3DConstants ["ImageTexture"]
   | X3DConstants ["ImageTexture3D"]
   | X3DConstants ["ImageTextureAtlas"]
   | X3DConstants ["IndexedFaceSet"]
   | X3DConstants ["IndexedLineSet"]
   | X3DConstants ["IndexedQuadSet"]
   | X3DConstants ["IndexedTriangleFanSet"]
   | X3DConstants ["IndexedTriangleSet"]
   | X3DConstants ["IndexedTriangleStripSet"]
   | X3DConstants ["Inline"]
   | X3DConstants ["IntegerSequencer"]
   | X3DConstants ["IntegerTrigger"]
   | X3DConstants ["IsoSurfaceVolumeData"]
   | X3DConstants ["KeySensor"]
   | X3DConstants ["Layer"]
   | X3DConstants ["LayerSet"]
   | X3DConstants ["Layout"]
   | X3DConstants ["LayoutGroup"]
   | X3DConstants ["LayoutLayer"]
   | X3DConstants ["LinePickSensor"]
   | X3DConstants ["LineProperties"]
   | X3DConstants ["LineSet"]
   | X3DConstants ["ListenerPointSource"]
   | X3DConstants ["LoadSensor"]
   | X3DConstants ["LocalFog"]
   | X3DConstants ["LOD"]
   | X3DConstants ["Material"]
   | X3DConstants ["Matrix3VertexAttribute"]
   | X3DConstants ["Matrix4VertexAttribute"]
   | X3DConstants ["MetadataBoolean"]
   | X3DConstants ["MetadataDouble"]
   | X3DConstants ["MetadataFloat"]
   | X3DConstants ["MetadataInteger"]
   | X3DConstants ["MetadataSet"]
   | X3DConstants ["MetadataString"]
   | X3DConstants ["MicrophoneSource"]
   | X3DConstants ["MotorJoint"]
   | X3DConstants ["MovieTexture"]
   | X3DConstants ["MultiTexture"]
   | X3DConstants ["MultiTextureCoordinate"]
   | X3DConstants ["MultiTextureTransform"]
   | X3DConstants ["NavigationInfo"]
   | X3DConstants ["Normal"]
   | X3DConstants ["NormalInterpolator"]
   | X3DConstants ["NurbsCurve"]
   | X3DConstants ["NurbsCurve2D"]
   | X3DConstants ["NurbsOrientationInterpolator"]
   | X3DConstants ["NurbsPatchSurface"]
   | X3DConstants ["NurbsPositionInterpolator"]
   | X3DConstants ["NurbsSet"]
   | X3DConstants ["NurbsSurfaceInterpolator"]
   | X3DConstants ["NurbsSweptSurface"]
   | X3DConstants ["NurbsSwungSurface"]
   | X3DConstants ["NurbsTextureCoordinate"]
   | X3DConstants ["NurbsTrimmedSurface"]
   | X3DConstants ["OpacityMapVolumeStyle"]
   | X3DConstants ["OrientationChaser"]
   | X3DConstants ["OrientationDamper"]
   | X3DConstants ["OrientationInterpolator"]
   | X3DConstants ["OrthoViewpoint"]
   | X3DConstants ["OscillatorSource"]
   | X3DConstants ["PackagedShader"]
   | X3DConstants ["ParticleSystem"]
   | X3DConstants ["PeriodicWave"]
   | X3DConstants ["PhysicalMaterial"]
   | X3DConstants ["PickableGroup"]
   | X3DConstants ["PixelTexture"]
   | X3DConstants ["PixelTexture3D"]
   | X3DConstants ["PlaneSensor"]
   | X3DConstants ["PointEmitter"]
   | X3DConstants ["PointLight"]
   | X3DConstants ["PointPickSensor"]
   | X3DConstants ["PointProperties"]
   | X3DConstants ["PointSet"]
   | X3DConstants ["Polyline2D"]
   | X3DConstants ["PolylineEmitter"]
   | X3DConstants ["Polypoint2D"]
   | X3DConstants ["PositionChaser"]
   | X3DConstants ["PositionChaser2D"]
   | X3DConstants ["PositionDamper"]
   | X3DConstants ["PositionDamper2D"]
   | X3DConstants ["PositionInterpolator"]
   | X3DConstants ["PositionInterpolator2D"]
   | X3DConstants ["PrimitivePickSensor"]
   | X3DConstants ["ProgramShader"]
   | X3DConstants ["ProjectionVolumeStyle"]
   | X3DConstants ["ProtoInstance"]
   | X3DConstants ["ProximitySensor"]
   | X3DConstants ["QuadSet"]
   | X3DConstants ["ReceiverPdu"]
   | X3DConstants ["Rectangle2D"]
   | X3DConstants ["RigidBody"]
   | X3DConstants ["RigidBodyCollection"]
   | X3DConstants ["ScalarChaser"]
   | X3DConstants ["ScalarDamper"]
   | X3DConstants ["ScalarInterpolator"]
   | X3DConstants ["ScreenFontStyle"]
   | X3DConstants ["ScreenGroup"]
   | X3DConstants ["Script"]
   | X3DConstants ["SegmentedVolumeData"]
   | X3DConstants ["ShadedVolumeStyle"]
   | X3DConstants ["ShaderPart"]
   | X3DConstants ["ShaderProgram"]
   | X3DConstants ["Shape"]
   | X3DConstants ["SignalPdu"]
   | X3DConstants ["SilhouetteEnhancementVolumeStyle"]
   | X3DConstants ["SingleAxisHingeJoint"]
   | X3DConstants ["SliderJoint"]
   | X3DConstants ["Sound"]
   | X3DConstants ["SpatialSound"]
   | X3DConstants ["Sphere"]
   | X3DConstants ["SphereSensor"]
   | X3DConstants ["SplinePositionInterpolator"]
   | X3DConstants ["SplinePositionInterpolator2D"]
   | X3DConstants ["SplineScalarInterpolator"]
   | X3DConstants ["SpotLight"]
   | X3DConstants ["SquadOrientationInterpolator"]
   | X3DConstants ["StaticGroup"]
   | X3DConstants ["StreamAudioDestination"]
   | X3DConstants ["StreamAudioSource"]
   | X3DConstants ["StringSensor"]
   | X3DConstants ["SurfaceEmitter"]
   | X3DConstants ["Switch"]
   | X3DConstants ["TexCoordChaser2D"]
   | X3DConstants ["TexCoordDamper2D"]
   | X3DConstants ["Text"]
   | X3DConstants ["TextureBackground"]
   | X3DConstants ["TextureCoordinate"]
   | X3DConstants ["TextureCoordinate3D"]
   | X3DConstants ["TextureCoordinate4D"]
   | X3DConstants ["TextureCoordinateGenerator"]
   | X3DConstants ["TextureProjector"]
   | X3DConstants ["TextureProjectorParallel"]
   | X3DConstants ["TextureProperties"]
   | X3DConstants ["TextureTransform"]
   | X3DConstants ["TextureTransform3D"]
   | X3DConstants ["TextureTransformMatrix3D"]
   | X3DConstants ["TimeSensor"]
   | X3DConstants ["TimeTrigger"]
   | X3DConstants ["ToneMappedVolumeStyle"]
   | X3DConstants ["TouchSensor"]
   | X3DConstants ["Transform"]
   | X3DConstants ["TransformSensor"]
   | X3DConstants ["TransmitterPdu"]
   | X3DConstants ["TriangleFanSet"]
   | X3DConstants ["TriangleSet"]
   | X3DConstants ["TriangleSet2D"]
   | X3DConstants ["TriangleStripSet"]
   | X3DConstants ["TwoSidedMaterial"]
   | X3DConstants ["UniversalJoint"]
   | X3DConstants ["UnlitMaterial"]
   | X3DConstants ["Viewpoint"]
   | X3DConstants ["ViewpointGroup"]
   | X3DConstants ["Viewport"]
   | X3DConstants ["VisibilitySensor"]
   | X3DConstants ["VolumeData"]
   | X3DConstants ["VolumeEmitter"]
   | X3DConstants ["VolumePickSensor"]
   | X3DConstants ["WaveShaper"]
   | X3DConstants ["WindPhysicsModel"]
   | X3DConstants ["WorldInfo"]
   | X3DConstants ["X3DAppearanceChildNode"]
   | X3DConstants ["X3DAppearanceNode"]
   | X3DConstants ["X3DBackgroundNode"]
   | X3DConstants ["X3DBindableNode"]
   | X3DConstants ["X3DBoundedObject"]
   | X3DConstants ["X3DChaserNode"]
   | X3DConstants ["X3DChildNode"]
   | X3DConstants ["X3DColorNode"]
   | X3DConstants ["X3DComposableVolumeRenderStyleNode"]
   | X3DConstants ["X3DComposedGeometryNode"]
   | X3DConstants ["X3DCoordinateNode"]
   | X3DConstants ["X3DDamperNode"]
   | X3DConstants ["X3DDragSensorNode"]
   | X3DConstants ["X3DEnvironmentalSensorNode"]
   | X3DConstants ["X3DEnvironmentTextureNode"]
   | X3DConstants ["X3DFogObject"]
   | X3DConstants ["X3DFollowerNode"]
   | X3DConstants ["X3DFontStyleNode"]
   | X3DConstants ["X3DGeometricPropertyNode"]
   | X3DConstants ["X3DGeometryNode"]
   | X3DConstants ["X3DGroupingNode"]
   | X3DConstants ["X3DInfoNode"]
   | X3DConstants ["X3DInterpolatorNode"]
   | X3DConstants ["X3DKeyDeviceSensorNode"]
   | X3DConstants ["X3DLayerNode"]
   | X3DConstants ["X3DLayoutNode"]
   | X3DConstants ["X3DLightNode"]
   | X3DConstants ["X3DMaterialNode"]
   | X3DConstants ["X3DMetadataObject"]
   | X3DConstants ["X3DNBodyCollidableNode"]
   | X3DConstants ["X3DNBodyCollisionSpaceNode"]
   | X3DConstants ["X3DNetworkSensorNode"]
   | X3DConstants ["X3DNode"]
   | X3DConstants ["X3DNormalNode"]
   | X3DConstants ["X3DNurbsControlCurveNode"]
   | X3DConstants ["X3DNurbsSurfaceGeometryNode"]
   | X3DConstants ["X3DOneSidedMaterialNode"]
   | X3DConstants ["X3DParametricGeometryNode"]
   | X3DConstants ["X3DParticleEmitterNode"]
   | X3DConstants ["X3DParticlePhysicsModelNode"]
   | X3DConstants ["X3DPickableObject"]
   | X3DConstants ["X3DPickSensorNode"]
   | X3DConstants ["X3DPointingDeviceSensorNode"]
   | X3DConstants ["X3DProductStructureChildNode"]
   | X3DConstants ["X3DProgrammableShaderObject"]
   | X3DConstants ["X3DPrototypeInstance"]
   | X3DConstants ["X3DRigidJointNode"]
   | X3DConstants ["X3DScriptNode"]
   | X3DConstants ["X3DSensorNode"]
   | X3DConstants ["X3DSequencerNode"]
   | X3DConstants ["X3DShaderNode"]
   | X3DConstants ["X3DShapeNode"]
   | X3DConstants ["X3DSingleTextureCoordinateNode"]
   | X3DConstants ["X3DSingleTextureNode"]
   | X3DConstants ["X3DSingleTextureTransformNode"]
   | X3DConstants ["X3DSoundChannelNode"]
   | X3DConstants ["X3DSoundDestinationNode"]
   | X3DConstants ["X3DSoundNode"]
   | X3DConstants ["X3DSoundProcessingNode"]
   | X3DConstants ["X3DSoundSourceNode"]
   | X3DConstants ["X3DStatement"]
   | X3DConstants ["X3DTexture2DNode"]
   | X3DConstants ["X3DTexture3DNode"]
   | X3DConstants ["X3DTextureCoordinateNode"]
   | X3DConstants ["X3DTextureNode"]
   | X3DConstants ["X3DTextureProjectorNode"]
   | X3DConstants ["X3DTextureTransformNode"]
   | X3DConstants ["X3DTimeDependentNode"]
   | X3DConstants ["X3DTouchSensorNode"]
   | X3DConstants ["X3DTriggerNode"]
   | X3DConstants ["X3DUrlObject"]
   | X3DConstants ["X3DVertexAttributeNode"]
   | X3DConstants ["X3DViewpointNode"]
   | X3DConstants ["X3DViewportNode"]
   | X3DConstants ["X3DVolumeDataNode"]
   | X3DConstants ["X3DVolumeRenderStyleNode"];
