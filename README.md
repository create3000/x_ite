...
[![Build Size](https://badgen.net/static/minified%20size%20(Brotli)/272.4%20kB/blue)](https://bundlephobia.com/package/x_ite)
...
```html
<script defer src="https://cdn.jsdelivr.net/npm/x_ite@16.2.0/dist/x_ite.min.js"></script>
<!-- or as ES module for use in scripts -->
<script type="module">
import X3D from "https://cdn.jsdelivr.net/npm/x_ite@16.2.0/dist/x_ite.min.mjs";
</script>
```
...
The following code examples initialize an X3D canvas within an HTML page, configuring it to contain a scene, a camera and a geometric cube with default material properties. It then animates the rotation of the cube within the scene, ensuring that the camera captures the dynamic action.
