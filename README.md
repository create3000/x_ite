...
```html
<script defer src="https://cdn.jsdelivr.net/npm/x_ite@11.5.4/dist/x_ite.min.js"></script>
<!-- or as ES module for use in scripts -->
<script type="module">
import X3D from "https://cdn.jsdelivr.net/npm/x_ite@11.5.4/dist/x_ite.min.mjs";
</script>
```
