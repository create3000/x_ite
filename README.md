...
[![Build Size](https://badgen.net/static/minified%20size%20(Brotli)/273.4%20kB/blue)](https://bundlephobia.com/package/x_ite)
...
```html
<script defer src="https://cdn.jsdelivr.net/npm/x_ite@16.4.0/dist/x_ite.min.js"></script>
<!-- or as ES module for use in scripts -->
<script type="module">
import X3D from "https://cdn.jsdelivr.net/npm/x_ite@16.4.0/dist/x_ite.min.mjs";
</script>
```
