...
Also try [x_ite-node](https://www.npmjs.com/package/x_ite-node), a pure Node.js version, without any dependencies on Electron. Suitable for just reading 3D files, analyzing, processing and generating X3D.
