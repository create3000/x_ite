...
If you are in production and everything is working well, then use a fixed version. You can get a list of all available versions here on [NPM](https://www.npmjs.com/package/x_ite?activeTab=versions).
