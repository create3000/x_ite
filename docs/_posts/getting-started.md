...
<table class="examples">
  <tr>
    ...
    <td>
      <a href="https://create3000.github.io/media/examples/X3D/BIC/BIC.x3d" title="X3D » BIC" componentName="X3D" typeName="BIC" doc="false" xr-button="br xrMovementControl="VIEWER_POSE"><img src="https://create3000.github.io/media/examples/X3D/BIC/screenshot-small.png" alt="BIC" width="110" height="62"/></a>
    </td>
    <td>
