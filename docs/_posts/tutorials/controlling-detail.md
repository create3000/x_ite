...
Group the shape versions as levels in an [LOD](../components/navigation/lod) grouping node:
...
An [LOD](../components/navigation/lod) grouping node creates a group of shapes describing different levels (versions) of the same shape:
...
Group the levels in an [LOD](../components/navigation/lod) node:
