...
- [TouchSensor](../components/pointingdevicesensor/touchsensor) senses touch
- [SphereSensor](../components/pointingdevicesensor/spheresensor) senses drags
- [CylinderSensor](../components/pointingdevicesensor/cylindersensor) senses drags
- [PlaneSensor](../components/pointingdevicesensor/planesensor) senses drags

The [Anchor](../components/networking/anchor) node is a special-purpose action sensor with a built-in response.
...
A [TouchSensor](../components/pointingdevicesensor/touchsensor) node senses the cursor's touch:
...
A [SphereSensor](../components/pointingdevicesensor/spheresensor) node senses a cursor drag and generates rotations as if rotating a ball:
...
A [CylinderSensor](../components/pointingdevicesensor/cylindersensor) node senses a cursor drag and generates rotations as if rotating a cylinder:
...
A [PlaneSensor](../components/pointingdevicesensor/planesensor) node senses a cursor drag and generates translations as if sliding on a plane:
