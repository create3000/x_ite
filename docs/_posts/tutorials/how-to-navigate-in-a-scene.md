...
- Double click an object to move quickly toward it. Double click again to seek toward a different object or point. Hold down the <kbd>Alt-or-Option</kbd> key to move to a certain point.
{: .prompt-tip }
