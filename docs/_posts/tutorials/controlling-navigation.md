...
- You can turn this headlight on and off
  ...
  - You can also control the headlight with the [NavigationInfo](https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/components/navigation.html#NavigationInfo){:target="_blank"} node

## Syntax: NavigationInfo

A [NavigationInfo](https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/components/navigation.html#NavigationInfo){:target="_blank"} node selects the navigation type and avatar characteristics:
