...
An [ImageTexture](../components/texturing/imagetexture) node selects a texture image for texture mapping:
...
A [PixelTexture](../components/texturing/pixeltexture) node specifies texture image pixels for texture mapping:
...
A [MovieTexture](../components/texturing/movietexture) node selects a texture movie for texture mapping:
...
- Color textures override the color in a [Material](../components/shape/material) node
...
- Specify the texture using an [ImageTexture](../components/texturing/imagetexture), [PixelTexture](../components/texturing/pixeltexture), or [MovieTexture](../components/texturing/movietexture) node in an [Appearance](../components/shape/appearance) node
