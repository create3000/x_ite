...
- The [Transform](https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/components/group.html#Transform){:target="_blank"} node creates a new coordinate system relative to its parent
- [Transform](https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/components/group.html#Transform){:target="_blank"} node fields do
  - *translation*
  - *rotation*
  - *scale*
