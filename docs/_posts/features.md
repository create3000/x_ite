...
* [x] [EXT_texture_avif](https://gltf-transform.dev/modules/extensions/classes/EXTTextureAVIF) [<i class="fa-regular fa-image example-icon" title="Comes with example."></i>](/x_ite/laboratory/gltf-sample-viewer/?url=https://create3000.github.io/media/glTF/ForestHouse/ForestHouse.glb)
