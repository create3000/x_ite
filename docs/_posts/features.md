...
- [x] [EXT_texture_video](https://github.com/takahirox/EXT_texture_video/README.md) [<i class="fa-regular fa-image example-icon" title="Comes with example."></i>](/x_ite/laboratory/gltf-sample-viewer/?url=https://create3000.github.io/media/glTF/BoxVideo/BoxVideo.gltf)
