...
Convert **X3D, VRML 2.0 (.wrl), glTF (GLB), VRM, OBJ, STL, PLY, SOG, SPZ, OFF,** and **SVG** to an X3D format of your choice. Files are converted offline, i.e. no data is transferred.
