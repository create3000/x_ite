...
The ScreenGroup node belongs to the **Layout** component and requires level **2**, its default container field is *children.* It is available from X3D version 3.2 or higher.
