...
**Layout** node is used as layout field of [LayoutLayer](/x_ite/components/layout/layoutlayer/) and [LayoutGroup](/x_ite/components/layout/layoutgroup/) nodes. **Layout** provides all parameters required to define the size, location and scale of a 2D rectangular region.
