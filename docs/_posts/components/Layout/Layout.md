...
The Layout node belongs to the **Layout** component and requires level **1,** its default container field is *layout.* It is available from X3D version 3.2 or higher.
