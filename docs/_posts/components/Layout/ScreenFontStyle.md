...
The ScreenFontStyle node belongs to the **Layout** component level **2** and its default container field is *fontStyle.* It is available from X3D version 3.2 or higher.
