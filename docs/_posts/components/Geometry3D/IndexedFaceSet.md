...
The IndexedFaceSet node belongs to the **Geometry3D** component level **2** and its default container field is *geometry.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
