...
The WindPhysicsModel node belongs to the **ParticleSystems** component and requires level **1,** its default container field is *physics.* It is available from X3D version 3.2 or higher.
