...
The ForcePhysicsModel node belongs to the **ParticleSystems** component level **1** and its default container field is *physics.* It is available from X3D version 3.2 or higher.
