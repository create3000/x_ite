...
[Cone](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/geometry3d/cone/) boundary for random distribution of particles about initial direction.
