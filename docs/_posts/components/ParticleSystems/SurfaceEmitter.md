...
<x3d-canvas class="xr-button-br" src="https://create3000.github.io/media/examples/ParticleSystems/SurfaceEmitter/SurfaceEmitter.x3d" update="auto" xrMovementControl=”VIEWER_POSE”></x3d-canvas>
