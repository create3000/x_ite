...
The SurfaceEmitter node belongs to the **ParticleSystems** component and requires level **2**, its default container field is *emitter.* It is available from X3D version 3.2 or higher.
