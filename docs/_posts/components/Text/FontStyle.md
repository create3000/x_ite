...
- [X3D Architecture Annex L, HTML authoring guidelines, CSS considerations](https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS//Part01/htmlGuidelines.html#CSS){:target="_blank"}
...
[Download ZIP Archive](https://create3000.github.io/media/examples/Text/FontStyle/FontStyle.zip) · [View Source in Playground](/x_ite/playground/?url=https://create3000.github.io/media/examples/Text/FontStyle/FontStyle.x3d)
