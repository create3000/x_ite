...
The FontStyle node belongs to the **Text** component and its default container field is *fontStyle.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
