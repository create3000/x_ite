...
The FontStyle node belongs to the **Text** component level **1** and its default container field is *fontStyle.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
