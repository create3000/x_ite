...
The MetadataDouble node belongs to the **Core** component and requires level **1**, its default container field is *value.* It is available from X3D version 3.0 or higher.
