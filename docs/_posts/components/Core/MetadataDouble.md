...
The MetadataDouble node belongs to the **Core** component and requires at least support level **1,** its default container field is *value.* It is available from X3D version 3.0 or higher.
...
| MFDouble | [in, out] | [value](#field-value) | [ ] |
{: .fields }
...
- The choice of MetadataDouble versus [MetadataFloat](/x_ite/components/core/metadatafloat/) usually depends on the relevant tool utilizing the value, or else the relevant metadata reference defining the value.
