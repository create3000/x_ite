...
The DynamicsCompressor node belongs to the **Sound** component and requires at least support level **2,** its default container field is *children.* It is available from X3D version 4.0 or higher.
...
| SFTime | \[in, out\] | [attack](#sftime-in-out-attack-0003-0) | 0 |
| SFFloat | \[in, out\] | [knee](#sffloat-in-out-knee-30-0) | 30  |
| SFFloat | \[in, out\] | [ratio](#sffloat-in-out-ratio-12-0) | 12  |
| SFTime | \[in, out\] | [release](#sftime-in-out-release-025-0) | 0 |
| SFFloat | \[in, out\] | [threshold](#sffloat-in-out-threshold--24-0) | -24  |
| SFFloat | \[out\] | [reduction](#sffloat-out-reduction-0-0) | 0  |
