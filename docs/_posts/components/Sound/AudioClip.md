...
The AudioClip node belongs to the **Sound** component and requires at least level **1,** its default container field is *source.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
...
[Download ZIP Archive](https://create3000.github.io/media/examples/Sound/AudioClip/AudioClip.zip) · [View Source in Playground](/x_ite/playground/?url=https://create3000.github.io/media/examples/Sound/AudioClip/AudioClip.x3d)
