...
The AudioClip node belongs to the **Sound** component and requires level **1,** its default container field is *source.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
