...
*fftSize* represents size of Fast Fourier [Transform](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/grouping/transform/) (FFT) used to determine frequency domain.
