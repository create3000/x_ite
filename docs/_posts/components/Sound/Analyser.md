...
The Analyser node belongs to the **Sound** component and requires level **2,** its default container field is *children.* It is available from X3D version 4.0 or higher.
