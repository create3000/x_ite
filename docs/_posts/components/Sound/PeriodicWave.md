...
The PeriodicWave node belongs to the **Sound** component level **2** and its default container field is *periodicWave.* It is available from X3D version 4.0 or higher.
