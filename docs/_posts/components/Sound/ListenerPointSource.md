...
| SFBool | \[in, out\] | [trackCurrentView](#sfbool-in-out-trackcurrentview-false) | FALSE |
...
| SFFloat | \[in, out\] | [interauralDistance](#sffloat-in-out-interauraldistance-0-0-small-classrednot-supported) | 0  |
