...
The ChannelSelector node belongs to the **Sound** component level **2** and its default container field is *children.* It is available from X3D version 4.0 or higher.
