...
The StaticGroup node belongs to the **Grouping** component and requires level **3,** its default container field is *children.* It is available from X3D version 3.0 or higher.
