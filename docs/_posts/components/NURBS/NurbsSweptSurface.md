...
The NurbsSweptSurface node belongs to the **NURBS** component and requires level **3**, its default container field is *geometry.* It is available from X3D version 3.0 or higher.
