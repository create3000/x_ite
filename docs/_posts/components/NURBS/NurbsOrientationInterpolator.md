...
The NurbsOrientationInterpolator node belongs to the **NURBS** component and its container field is *children.* It is available since X3D version 3.0 or later.
