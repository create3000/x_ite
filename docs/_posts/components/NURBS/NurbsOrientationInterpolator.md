...
The NurbsOrientationInterpolator node belongs to the **NURBS** component and requires level **1,** its default container field is *children.* It is available from X3D version 3.0 or higher.
