...
The NurbsTextureCoordinate node belongs to the **NURBS** component and requires level **1**, its default container field is *texCoord.* It is available from X3D version 3.0 or higher.
