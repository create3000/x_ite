...
- Contour2D is used as the trimmingContour field of the [NurbsTrimmedSurface](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/nurbs/nurbstrimmedsurface/) node.
