...
The Contour2D node belongs to the **NURBS** component level **4** and its default container field is *trimmingContour.* It is available from X3D version 3.0 or higher.
