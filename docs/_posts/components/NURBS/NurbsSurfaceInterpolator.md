...
The NurbsSurfaceInterpolator node belongs to the **NURBS** component level **1** and its default container field is *children.* It is available from X3D version 3.0 or higher.
