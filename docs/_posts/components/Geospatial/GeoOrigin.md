...
The GeoOrigin node belongs to the **Geospatial** component and requires level **1**, its default container field is *geoOrigin.* It is available from X3D version 3.0 or higher.
