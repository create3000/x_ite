...
**GeoPositionInterpolator** animates objects within a geographic coordinate system. **GeoPositionInterpolator** can contain a [GeoOrigin](/x_ite/components/geospatial/geoorigin/) node.
