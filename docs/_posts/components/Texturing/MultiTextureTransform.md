...
The MultiTextureTransform node belongs to the **Texturing** component level **2** and its default container field is *textureTransform.* It is available from X3D version 3.0 or higher.
