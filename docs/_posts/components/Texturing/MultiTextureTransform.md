...
The MultiTextureTransform node belongs to the **Texturing** component and its container field is *textureTransform.* It is available since X3D version 3.0 or later.
