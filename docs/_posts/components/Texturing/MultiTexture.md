...
The MultiTexture node belongs to the **Texturing** component and requires level **2,** its default container field is *texture.* It is available from X3D version 3.0 or higher.
