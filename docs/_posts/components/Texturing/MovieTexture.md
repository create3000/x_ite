...
The MovieTexture node belongs to the **Texturing** component level **3** and its default container field is *texture.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
