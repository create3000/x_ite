...
The ImageTexture node belongs to the **Texturing** component and requires level **1**, its default container field is *texture.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
