...
The TransformSensor node belongs to the **EnvironmentalSensor** component level **3** and its default container field is *children.* It is available from X3D version 3.2 or higher.
