...
The Billboard node belongs to the **Navigation** component and requires level **2,** its default container field is *children.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
