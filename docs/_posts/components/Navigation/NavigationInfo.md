...
- See [Collision](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/navigation/collision/) node for further details on camera-to-object collision detection.
...
- This field may be ignored, applying the default value regardless.
- Transformation hierarchy of currently bound [Viewpoint](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/navigation/viewpoint/) node scales *avatarSize*, but translations and rotations have no effect.
