...
The ProjectionVolumeStyle node belongs to the **VolumeRendering** component level **2** and its default container field is *renderStyle.* It is available from X3D version 3.3 or higher.
