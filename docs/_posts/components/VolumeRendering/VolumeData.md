...
<x3d-canvas class="xr-button-br" src="https://create3000.github.io/media/examples/VolumeRendering/VolumeData/VolumeData.x3d" contentScale="auto" update="auto" xrMovementControl="VIEWER_POSE"></x3d-canvas>
