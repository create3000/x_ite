...
The SilhouetteEnhancementVolumeStyle node belongs to the **VolumeRendering** component and requires level **2**, its default container field is *renderStyle.* It is available from X3D version 3.3 or higher.
