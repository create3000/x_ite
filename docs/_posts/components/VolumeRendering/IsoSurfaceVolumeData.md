...
The IsoSurfaceVolumeData node belongs to the **VolumeRendering** component level **2** and its default container field is *children.* It is available from X3D version 3.3 or higher.
