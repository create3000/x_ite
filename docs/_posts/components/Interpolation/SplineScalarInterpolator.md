...
The SplineScalarInterpolator node belongs to the **Interpolation** component level **4** and its default container field is *children.* It is available from X3D version 3.2 or higher.
