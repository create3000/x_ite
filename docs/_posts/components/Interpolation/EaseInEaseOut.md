...
**EaseInEaseOut** enables gradual animation transitions by modifying [TimeSensor](/x_ite/components/time/timesensor/) fraction outputs. Output values are modified fractions. Authors can ROUTE value_changed output events to an interpolator, a sequencer, or another SFFloat attribute.
