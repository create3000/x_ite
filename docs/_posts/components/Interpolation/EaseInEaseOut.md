...
The EaseInEaseOut node belongs to the **Interpolation** component and requires level **4,** its default container field is *children.* It is available from X3D version 3.2 or higher.
