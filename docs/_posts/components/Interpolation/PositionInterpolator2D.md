...
**PositionInterpolator2D** generates a series of SFVec2f values. Authors can ROUTE value_changed output events to an SFVec2f attribute.
...
<x3d-canvas class="buttons-br" src="https://create3000.github.io/media/examples/Interpolation/PositionInterpolator2D/PositionInterpolator2D.x3d" contentScale="auto" update="auto">
