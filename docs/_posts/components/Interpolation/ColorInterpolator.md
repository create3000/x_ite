...
The ColorInterpolator node belongs to the **Interpolation** component level **2** and its default container field is *children.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
