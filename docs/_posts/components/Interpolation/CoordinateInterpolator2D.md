...
**CoordinateInterpolator2D** generates a series of SFVec2f or MFVec2f 2-tuple float values. Authors can ROUTE value_changed output events to an SFVec2f or MFVec2f attribute.
