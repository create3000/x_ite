...
The LocalFog node belongs to the **EnvironmentalEffects** component and requires level **4,** its default container field is *children.* It is available from X3D version 3.0 or higher.
