...
<x3d-canvas class="xr-button-tr" src="https://create3000.github.io/media/examples/EnvironmentalEffects/LocalFog/LocalFog.x3d" update="auto" xrMovementControl="VIEWER_POSE"></x3d-canvas>
