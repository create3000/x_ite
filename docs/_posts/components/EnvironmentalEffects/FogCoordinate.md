...
The FogCoordinate node belongs to the **EnvironmentalEffects** component and its container field is *fogCoord.* It is available since X3D version 3.0 or later.
