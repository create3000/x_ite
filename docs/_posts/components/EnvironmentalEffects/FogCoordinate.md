...
The FogCoordinate node belongs to the **EnvironmentalEffects** component and requires level **4**, its default container field is *fogCoord.* It is available from X3D version 3.0 or higher.
