...
The TextureTransform3D node belongs to the **Texturing3D** component level **1** and its default container field is *textureTransform.* It is available from X3D version 3.1 or higher.
