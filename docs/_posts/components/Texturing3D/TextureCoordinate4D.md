...
The TextureCoordinate4D node belongs to the **Texturing3D** component and requires at least support level **1,** its default container field is *texCoord.* It is available from X3D version 3.1 or higher.
...
- MFVec4f \[in, out\] [point](#mfvec4f-in-out-point----)
