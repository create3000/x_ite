...
The TextureTransformMatrix3D node belongs to the **Texturing3D** component and its container field is *textureTransform.* It is available since X3D version 3.1 or later.
