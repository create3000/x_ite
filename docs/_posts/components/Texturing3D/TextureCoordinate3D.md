...
**TextureCoordinate3D** specifies a set of 3D texture coordinates used by vertex-based geometry nodes (such as [IndexedFaceSet](/x_ite/components/geometry3d/indexedfaceset/) or [ElevationGrid](/x_ite/components/geometry3d/elevationgrid/)) to map 3D textures to vertices.
