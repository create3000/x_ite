...
The Layer node belongs to the **Layering** component and requires level **1**, its default container field is *layers.* It is available from X3D version 3.2 or higher.
