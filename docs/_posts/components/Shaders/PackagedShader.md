...
The PackagedShader node belongs to the **Shaders** component and requires level **1,** its default container field is *shaders.* It is available from X3D version 3.0 or higher.
