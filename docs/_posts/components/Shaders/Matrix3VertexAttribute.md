...
The Matrix3VertexAttribute node belongs to the **Shaders** component and requires level **1**, its default container field is *attrib.* It is available from X3D version 3.0 or higher.
