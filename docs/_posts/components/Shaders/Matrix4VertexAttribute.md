...
The Matrix4VertexAttribute node belongs to the **Shaders** component level **1** and its default container field is *attrib.* It is available from X3D version 3.0 or higher.
