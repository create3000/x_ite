...
The TimeSensor node belongs to the **Time** component and requires level **1,** its default container field is *children.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
