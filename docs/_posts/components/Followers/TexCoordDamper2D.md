...
The TexCoordDamper2D node belongs to the **Followers** component level **1** and its default container field is *children.* It is available from X3D version 3.2 or higher.
