...
- ROUTE value_changed output events to a \<[TextureTransform](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/texturing/texturetransform/)\> node's translation field, for example.
