...
The DISEntityManager node belongs to the **DIS** component and requires level **2,** its default container field is *children.* It is available from X3D version 3.0 or higher.
