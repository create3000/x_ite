...
The HAnimMotion node belongs to the **HAnim** component and requires level **2**, its default container field is *motions.* It is available from X3D version 4.0 or higher.
