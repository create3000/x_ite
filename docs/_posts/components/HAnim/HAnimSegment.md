...
The HAnimSegment node belongs to the **HAnim** component and requires level **1**, its default container field is *children.* It is available from X3D version 3.0 or higher.
