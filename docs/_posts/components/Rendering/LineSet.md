...
The LineSet node belongs to the **Rendering** component and requires level **1,** its default container field is *geometry.* It is available from X3D version 3.0 or higher.
