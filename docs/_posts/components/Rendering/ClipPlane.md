...
The ClipPlane node belongs to the **Rendering** component and requires level **5**, its default container field is *children.* It is available from X3D version 3.2 or higher.
