...
The ClipPlane node belongs to the **Rendering** component level **5** and its default container field is *children.* It is available from X3D version 3.2 or higher.
