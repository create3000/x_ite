...
The Color node belongs to the **Rendering** component level **1** and its default container field is *color.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
