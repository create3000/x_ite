...
The Normal node belongs to the **Rendering** component and requires level **2**, its default container field is *normal.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
