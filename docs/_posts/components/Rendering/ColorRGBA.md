...
The ColorRGBA node belongs to the **Rendering** component and requires level **1,** its default container field is *color.* It is available from X3D version 3.0 or higher.
