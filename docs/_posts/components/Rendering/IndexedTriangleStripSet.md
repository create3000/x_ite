...
*index* list specifies triangles by connecting [Coordinate](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/rendering/coordinate/) vertices for each individual strip, separated by -1 sentinel values.
