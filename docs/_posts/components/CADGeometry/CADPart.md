...
The CADPart node belongs to the **CADGeometry** component and requires level **2,** its default container field is *children.* It is available from X3D version 3.1 or higher.
