...
The IndexedQuadSet node belongs to the **CADGeometry** component and requires level **1,** its default container field is *geometry.* It is available from X3D version 3.1 or higher.
