...
The IndexedQuadSet node belongs to the **CADGeometry** component and requires at least support level **1,** its default container field is *geometry.* It is available from X3D version 3.1 or higher.
