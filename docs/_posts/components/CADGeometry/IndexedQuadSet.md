...
The IndexedQuadSet node belongs to the **CADGeometry** component level **1** and its default container field is *geometry.* It is available from X3D version 3.1 or higher.
