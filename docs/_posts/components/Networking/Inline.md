...
The Inline node belongs to the **Networking** component and requires level **2,** its default container field is *children.* It is available since VRML 2.0 and from X3D version 3.0 or higher.
...
- [X3D Architecture, 17.2.1.2 Scoping of lights](https://www.web3d.org/specifications/X3Dv4Draft/ISO-IEC19775-1v4-IS.proof//Part01/components/lighting.html#ScopingOfLights){:target="_blank"}
...
- [(X3D version 4.0 ISO.proof draft) support includes .gltf and .glb](https://www.khronos.org/gltf){:target="_blank"} https://en.wikipedia.org/wiki/glTF
