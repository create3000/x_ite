...
The ArcClose2D node belongs to the **Geometry2D** component level **2** and its default container field is *geometry.* It is available from X3D version 3.0 or higher.
