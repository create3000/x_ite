...
<x3d-canvas class="xr-button-br" src="https://create3000.github.io/media/examples/Geometry2D/ArcClose2D/ArcClose2D.x3d" update="auto" xrMovementControl="VIEWER_POSE"></x3d-canvas>
