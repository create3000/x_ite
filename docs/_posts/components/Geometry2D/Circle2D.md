...
The Circle2D node belongs to the **Geometry2D** component and requires level **2,** its default container field is *geometry.* It is available from X3D version 3.0 or higher.
