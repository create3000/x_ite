...
>**Deprecated:** This node is deprecated as of X3D version 4.0. Future versions of the standard may remove this node. Please use [Appearance](/x_ite/components/shape/appearance/) node *backMaterial* field instead.
{: .prompt-danger }
...
- [X3D Architecture 12.2.3 Two-sided materials](https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS){:target="_blank"} /Part01/components/shape.html#TwoSidedMaterials
