...
The TwoSidedMaterial node belongs to the **Shape** component and its container field is *material.* It is available since X3D version 3.2 or later.
...
### SFFloat [in, out] **backTransparency** <small>[0,1]</small>
