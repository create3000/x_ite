...
The TwoSidedMaterial node belongs to the **Shape** component level **4** and its default container field is *material.* It is available from X3D version 3.2 up to 4.0.
