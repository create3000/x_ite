...
The LineProperties node belongs to the **Shape** component level **2** and its default container field is *lineProperties.* It is available from X3D version 3.0 or higher.
