...
Single contained [BlendMode](../x_ite/blendbode) node that defines blend mode properties.

### SFNode [in, out] **depthMode** NULL <small>[DepthMode]</small> <small class="yellow">non standard</small>

Single contained [DepthMode](../x_ite/depthmode) node that defines depth mode properties.
