...
The UnlitMaterial node belongs to the **Shape** component and requires level **1**, its default container field is *material.* It is available from X3D version 4.0 or higher.
...
- [X3D Specification of UnlitMaterial node](https://www.web3d.org/documents/specifications/19775-1/V4.0/Part01/components/shape.html#UnlitMaterial){:target="_blank"}
