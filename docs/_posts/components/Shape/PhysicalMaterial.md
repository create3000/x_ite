...
The PhysicalMaterial node belongs to the **Shape** component level **2** and its default container field is *material.* It is available from X3D version 4.0 or higher.
