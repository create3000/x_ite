...
The PhysicalMaterial node belongs to the **Shape** component and requires level **2,** its default container field is *material.* It is available from X3D version 4.0 or higher.
