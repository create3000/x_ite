...
The FillProperties node belongs to the **Shape** component and requires level **3**, its default container field is *fillProperties.* It is available from X3D version 3.0 or higher.
