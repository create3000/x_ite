...
- SFNode \[in, out\] [ambientTexture](#sfnode-in-out-ambienttexture-null-x3dsingletexturenode)
...
- SFNode \[in, out\] [shininessTexture](#sfnode-in-out-shininesstexture-null-x3dsingletexturenode)
