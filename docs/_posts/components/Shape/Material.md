...
<x3d-canvas class="xr-button-br" src="https://create3000.github.io/media/examples/Shape/Material/Material.x3d" update="auto" xrMovementControl=”VIEWER_POSE”></x3d-canvas>
