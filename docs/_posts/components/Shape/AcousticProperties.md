...
The AcousticProperties node belongs to the **Shape** component and requires level **5,** its default container field is *acousticProperties.* It is available from X3D version 4.0 or higher.
