...
The AcousticProperties node belongs to the **Shape** component level **5** and its default container field is *acousticProperties.* It is available from X3D version 4.0 or higher.
