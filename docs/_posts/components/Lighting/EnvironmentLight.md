...
- [DirectionalLight](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/lighting/directionallight/) default *global*=false to limit scope and avoid inadvertently illuminating every object in a large scene. [PointLight](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/lighting/pointlight/) and [SpotLight](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/lighting/spotlight/) default *global*=true since their effects are each limited by maximum radius value.
