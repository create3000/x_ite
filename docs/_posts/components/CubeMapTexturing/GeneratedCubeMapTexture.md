...
The GeneratedCubeMapTexture node belongs to the **CubeMapTexturing** component level **3** and its default container field is *texture.* It is available from X3D version 3.0 or higher.
