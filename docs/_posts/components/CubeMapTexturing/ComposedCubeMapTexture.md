...
The ComposedCubeMapTexture node belongs to the **CubeMapTexturing** component level **1** and its default container field is *texture.* It is available from X3D version 3.1 or higher.
