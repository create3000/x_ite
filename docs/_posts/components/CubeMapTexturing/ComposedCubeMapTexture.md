...
The ComposedCubeMapTexture node belongs to the **CubeMapTexturing** component and requires level **1**, its default container field is *texture.* It is available from X3D version 3.1 or higher.
