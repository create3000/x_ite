...
- This field differs for [TextureProjectorParallel](/x_ite/components//users/holger/desktop/x_ite/x_ite/docs/_posts/components/textureprojection/textureprojectorparallel/) and TextureProjector.
