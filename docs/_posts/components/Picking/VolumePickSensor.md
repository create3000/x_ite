...
The VolumePickSensor node belongs to the **Picking** component and requires level **3**, its default container field is *children.* It is available from X3D version 3.2 or higher.
