...
The LinePickSensor node belongs to the **Picking** component level **1** and its default container field is *children.* It is available from X3D version 3.2 or higher.
