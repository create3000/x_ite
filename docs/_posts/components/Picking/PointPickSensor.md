...
| SFString | \[ \] | [sortOrder](#sfstring---sortorder-closest-closestallall_sorted) | "CLOSEST"  |
| SFBool | \[out\] | [isActive](#sfbool-out-isactive) |  |
| MFVec3f | \[out\] | [pickedPoint](#mfvec3f-out-pickedpoint) |  |
| SFNode | \[in, out\] | [pickingGeometry](#sfnode-in-out-pickinggeometry-null-pointset) | NULL  |
