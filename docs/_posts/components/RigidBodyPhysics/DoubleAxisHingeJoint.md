...
**DoubleAxisHingeJoint** has two independent axes located around a common anchor point. axis1 has limits and a motor, axis 2 only has a motor Contains two [RigidBody](/x_ite/components/rigidbodyphysics/rigidbody/) nodes (containerField values body1, body2).
