...
**SingleAxisHingeJoint** has single axis about which to rotate, similar to a traditional door hinge. Contains two [RigidBody](/x_ite/components/rigidbodyphysics/rigidbody/) nodes (containerField values body1, body2).
...
<x3d-canvas class="buttons-br" src="https://create3000.github.io/media/examples/RigidBodyPhysics/SingleAxisHingeJoint/SingleAxisHingeJoint.x3d" contentScale="auto" update="auto">
