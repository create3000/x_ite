...
**MotorJoint** drives relative angular velocities between body1 and body2 within a common reference frame. Contains two [RigidBody](/x_ite/components/rigidbodyphysics/rigidbody/) nodes (containerField values body1, body2).
