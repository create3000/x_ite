...
The MotorJoint node belongs to the **RigidBodyPhysics** component and requires level **2,** its default container field is *joints.* It is available from X3D version 3.2 or higher.
