...
**CollidableOffset** repositions geometry relative to center of owning body. Contains a single [CollidableShape](/x_ite/components/rigidbodyphysics/collidableshape/) or **CollidableOffset** node (`containerField='collidable').`
