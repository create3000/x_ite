...
The CollidableOffset node belongs to the **RigidBodyPhysics** component and requires level **1,** its default container field is *children.* It is available from X3D version 3.2 or higher.
