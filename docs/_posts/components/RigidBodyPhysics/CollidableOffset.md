...
The CollidableOffset node belongs to the **RigidBodyPhysics** component and its container field is *children.* It is available since X3D version 3.2 or later.
