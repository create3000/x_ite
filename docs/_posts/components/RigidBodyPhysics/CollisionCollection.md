...
The CollisionCollection node belongs to the **RigidBodyPhysics** component level **1** and its default container field is *collider.* It is available from X3D version 3.2 or higher.
