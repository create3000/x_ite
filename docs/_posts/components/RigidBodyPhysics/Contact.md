...
The Contact node belongs to the **RigidBodyPhysics** component level **2** and its default container field is *contacts.* It is available from X3D version 3.2 or higher.
