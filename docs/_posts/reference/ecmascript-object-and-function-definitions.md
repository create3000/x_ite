...
tags: [ECMAScript, Javascript, Overview]
---
## Overview
...
A reference to the [X3DBrowser](/x_ite/reference/browser-services/#x3dbrowser-object) object that is associated with this element. This property is read-only.
